            ...
            if(count1 == 12):
                ...
                if(is_valid_json(json_data)):
                        ...
                        if(findBool(json_obj['connected'])):
                            ...
                            '''
                            dic['Braid9_1'] = json_obj['tags']['M-B_R_9-0'] #PIR
                            dic['Braid9_2'] = json_obj['tags']['M-B_R_9-1'] #operator name
                            dic['Braid9_3'] = json_obj['tags']['M-B_R_9-2'] #deck set speed
                            dic['Braid9_4'] = json_obj['tags']['M-B_R_9-3'] #deck act speed
                            dic['Braid9_5'] = json_obj['tags']['M-B_R_9-4'] #production meter
                            dic['Braid9_6'] = json_obj['tags']['M-B_R_9-5'] #total running hrs
                            dic['Braid9_7'] = json_obj['tags']['M-B_R_9-6'] #blower ser temperature 
                            dic['Braid9_8'] = json_obj['tags']['M-B_R_9-7'] #blower act temperature
                            dic['Braid9_9'] = json_obj['tags']['M-B_R_9-8'] #N2 set temperature
                            dic['Braid9_10'] = json_obj['tags']['M-B_R_9-9'] #N2 inlet temperature
                            dic['Braid9_11'] = json_obj['tags']['M-B_R_9-10'] #N2 outlet temperature
                            dic['Braid9_12'] = json_obj['tags']['M-B_R_9-11'] #N2 pressure
                            '''
                            ...
                            '''
                            dic['BraidStop9_1'] = json_obj['tags']['M-B_S_9-0'] #Int value containing 1-20 value's
                            dic['BraidStop9_2'] = json_obj['tags']['M-B_S_9-1'] #Boolean value containing on off status
                            dic['BraidStopMessage9'] = ""
                            ...
                            '''
                            dic['Alarm9_1'] = json_obj['tags']['M-B_A_9-0'] #MACHINE EMERGENCY PRESSED
                            dic['Alarm9_2'] = json_obj['tags']['M-B_A_9-1'] #DOOR NOT CLOSED
                            dic['Alarm9_3'] = json_obj['tags']['M-B_A_9-2'] #CLOSE FRONT RIGHT DOOR AND PRESS RESET
                            dic['Alarm9_4'] = json_obj['tags']['M-B_A_9-3'] #CLOSE FRONT LEFT DOOR AND PRESS RESET
                            dic['Alarm9_5'] = json_obj['tags']['M-B_A_9-4'] #CLOSE BACK RIGHT DOOR AND PRESS RESET
                            dic['Alarm9_6'] = json_obj['tags']['M-B_A_9-5'] #CLOSE BACK LEFT DOOR AND PRESS RESET
                            dic['Alarm9_7'] = json_obj['tags']['M-B_A_9-6'] #BOBBIN EMPTY D1 INNER ACTIVATED
                            dic['Alarm9_8'] = json_obj['tags']['M-B_A_9-7'] #BOBBIN EMPTY D1 OUTER ACTIVATED
                            dic['Alarm9_9'] = json_obj['tags']['M-B_A_9-8'] #BOBBIN EMPTY D2 INNER ACTIVATED
                            dic['Alarm9_10'] = json_obj['tags']['M-B_A_9-9'] #BOBBIN EMPTY D2 OUTER ACTIVATED
                            dic['Alarm9_11'] = json_obj['tags']['M-B_A_9-10'] #WIRE BREAK D1 BACK ACTIVATED
                            dic['Alarm9_12'] = json_obj['tags']['M-B_A_9-11'] #WIRE BREAK D1 FRONT ACTIVATED
                            dic['Alarm9_13'] = json_obj['tags']['M-B_A_9-12'] #WIRE BREAK D2 BACK ACTIVATED
                            dic['Alarm9_14'] = json_obj['tags']['M-B_A_9-13'] #WIRE BREAK D2 OUTER ACTIVATED
                            dic['Alarm9_15'] = json_obj['tags']['M-B_A_9-14'] #OIL LEVEL D2 SENSOR ACTIVATED
                            dic['Alarm9_16'] = json_obj['tags']['M-B_A_9-15'] #MPCB TRIP ACTIVATED
                            dic['Alarm9_17'] = json_obj['tags']['M-B_A_9-16'] #RUNNING PLY SENSOR ACTIVATED
                            dic['Alarm9_18'] = json_obj['tags']['M-B_A_9-17'] #OIL LEVEL D1 SENSOR ACTIVATED
                            dic['Alarm9_19'] = json_obj['tags']['M-B_A_9-18'] #TAKE UP EMERGENGY ACTIVATED
                            dic['Alarm9_20'] = json_obj['tags']['M-B_A_9-19'] #WIRE BREAK D1 TOP ACTIVATED
                            dic['Alarm9_21'] = json_obj['tags']['M-B_A_9-20'] #WIRE BREAK D2 TOP ACTIVATED
                            '''
                            ...
                            '''
                            dic['BraidPims9_1'] = json_obj['tags']['M-B_P_9-0'] #DRUM IN
                            dic['BraidPims9_2'] = json_obj['tags']['M-B_P_9-1'] #DRUM OUT
                            dic['BraidPims9_3'] = json_obj['tags']['M-B_P_9-2'] #RED TAPE METER 1
                            dic['BraidPims9_4'] = json_obj['tags']['M-B_P_9-3'] #RED TAPE METER 2
                            dic['BraidPims9_5'] = json_obj['tags']['M-B_P_9-4'] #RED TAPE METER 3
                            dic['BraidPims9_6'] = json_obj['tags']['M-B_P_9-5'] #RED TAPE METER 4
                            dic['BraidPims9_7'] = json_obj['tags']['M-B_P_9-6'] #RED TAPE METER 5
                            dic['BraidPims9_8'] = json_obj['tags']['M-B_P_9-7'] #RED TAPE METER 6
                            dic['BraidPims9_9'] = json_obj['tags']['M-B_P_9-8'] #RED TAPE METER 7
                            dic['BraidPims9_10'] = json_obj['tags']['M-B_P_9-9'] #RED TAPE METER 8
                            dic['BraidPims9_11'] = json_obj['tags']['M-B_P_9-10'] #RED TAPE METER 9
                            dic['BraidPims9_12'] = json_obj['tags']['M-B_P_9-11'] #RED TAPE METER 10
                            dic['BraidPims9_13'] = json_obj['tags']['M-B_P_9-12'] #RED TAPE METER 11
                            dic['BraidPims9_14'] = json_obj['tags']['M-B_P_9-13'] #RED TAPE METER 12
                            dic['BraidPims9_15'] = json_obj['tags']['M-B_P_9-14'] #RED TAPE METER 13
                            dic['BraidPims9_16'] = json_obj['tags']['M-B_P_9-15']#RED TAPE METER 14
                            dic['BraidPims9_17'] = json_obj['tags']['M-B_P_9-16'] #RED TAPE METER 15
                            dic['BraidPims9_18'] = json_obj['tags']['M-B_P_9-17'] #RED TAPE METER 16
                            dic['BraidPims9_19'] = json_obj['tags']['M-B_P_9-18'] #RED TAPE METER 17
                            dic['BraidPims9_20'] = json_obj['tags']['M-B_P_9-19'] #RED TAPE METER 18
                            dic['BraidPims9_21'] = json_obj['tags']['M-B_P_9-20'] #RED TAPE METER 19
                            dic['BraidPims9_22'] = json_obj['tags']['M-B_P_9-21'] #RED TAPE METER 20
                            dic['BraidPims9_23'] = json_obj['tags']['M-B_P_9-22'] #RED TAPE METER 21
                            dic['BraidPims9_24'] = json_obj['tags']['M-B_P_9-23'] #RED TAPE METER 22
                            dic['BraidPims9_25'] = json_obj['tags']['M-B_P_9-24'] #RED TAPE METER 23
                            dic['BraidPims9_26'] = json_obj['tags']['M-B_P_9-25'] #RED TAPE METER 24
                            dic['BraidPims9_27'] = json_obj['tags']['M-B_P_9-26'] #RED TAPE METER 25
                            dic['BraidPims9_28'] = json_obj['tags']['M-B_P_9-27'] #RED TAPE METER 26
                            dic['BraidPims9_29'] = json_obj['tags']['M-B_P_9-28'] #RED TAPE METER 27
                            dic['BraidPims9_30'] = json_obj['tags']['M-B_P_9-29'] #RED TAPE METER 28
                            dic['BraidPims9_31'] = json_obj['tags']['M-B_P_9-30'] #RED TAPE METER 29
                            dic['BraidPims9_32'] = json_obj['tags']['M-B_P_9-31']#RED TAPE METER 30
                            dic['BraidPims9_33'] = json_obj['tags']['M-B_P_9-32'] #RED TAPE METER 31
                            dic['BraidPims9_34'] = json_obj['tags']['M-B_P_9-33'] #RED TAPE METER 32
                            dic['BraidPims9_35'] = json_obj['tags']['M-B_P_9-34'] #RED TAPE METER 33
                            dic['BraidPims9_36'] = json_obj['tags']['M-B_P_9-35'] #RED TAPE METER 34
                            dic['BraidPims9_37'] = json_obj['tags']['M-B_P_9-36'] #RED TAPE METER 35
                            dic['BraidPims9_38'] = json_obj['tags']['M-B_P_9-37'] #RED TAPE METER 36
                            dic['BraidPims9_39'] = json_obj['tags']['M-B_P_9-38'] #RED TAPE METER 37
                            dic['BraidPims9_40'] = json_obj['tags']['M-B_P_9-39'] #RED TAPE METER 38
                            dic['BraidPims9_41'] = json_obj['tags']['M-B_P_9-40'] #RED TAPE METER 39
                            dic['BraidPims9_42'] = json_obj['tags']['M-B_P_9-41'] #RED TAPE METER 40
                            dic['BraidPims9_43'] = json_obj['tags']['M-B_P_9-42'] #RED TAPE METER 41
                            dic['BraidPims9_44'] = json_obj['tags']['M-B_P_9-43'] #RED TAPE METER 42
                            dic['BraidPims9_45'] = json_obj['tags']['M-B_P_9-44'] #RED TAPE METER 43
                            dic['BraidPims9_46'] = json_obj['tags']['M-B_P_9-45'] #RED TAPE METER 44
                            dic['BraidPims9_47'] = json_obj['tags']['M-B_P_9-46'] #RED TAPE METER 45
                            dic['BraidPims9_48'] = json_obj['tags']['M-B_P_9-47'] #RED TAPE METER 46
                            dic['BraidPims9_49'] = json_obj['tags']['M-B_P_9-48'] #RED TAPE METER 47
                            dic['BraidPims9_50'] = json_obj['tags']['M-B_P_9-49'] #RED TAPE METER 48
                            dic['BraidPims9_51'] = json_obj['tags']['M-B_P_9-50'] #RED TAPE METER 49
                            dic['BraidPims9_52'] = json_obj['tags']['M-B_P_9-51']#RED TAPE METER 50
                            dic['BraidPims9_53'] = json_obj['tags']['M-B_P_9-52'] #RED TAPE METER 51
                            dic['BraidPims9_54'] = json_obj['tags']['M-B_P_9-53'] #RED TAPE METER 52
                            dic['BraidPims9_55'] = json_obj['tags']['M-B_P_9-54'] #RED TAPE METER 53
                            dic['BraidPims9_56'] = json_obj['tags']['M-B_P_9-55'] #RED TAPE METER 54
                            dic['BraidPims9_57'] = json_obj['tags']['M-B_P_9-56'] #RED TAPE METER 55
                            dic['BraidPims9_58'] = json_obj['tags']['M-B_P_9-57'] #RED TAPE METER 56
                            dic['BraidPims9_59'] = json_obj['tags']['M-B_P_9-58'] #RED TAPE METER 57
                            dic['BraidPims9_60'] = json_obj['tags']['M-B_P_9-59'] #RED TAPE METER 58
                            dic['BraidPims9_61'] = json_obj['tags']['M-B_P_9-60'] #RED TAPE METER 59
                            dic['BraidPims9_62'] = json_obj['tags']['M-B_P_9-61'] #RED TAPE METER 60
                            dic['BraidPims9_63'] = json_obj['tags']['M-B_P_9-62'] #RED TAPE METER 61
                            dic['BraidPims9_64'] = json_obj['tags']['M-B_P_9-63'] #RED TAPE METER 62
                            dic['BraidPims9_65'] = json_obj['tags']['M-B_P_9-64'] #RED TAPE METER 63
                            dic['BraidPims9_66'] = json_obj['tags']['M-B_P_9-65'] #RED TAPE METER 64
                            dic['BraidPims9_67'] = json_obj['tags']['M-B_P_9-66'] #RED TAPE METER 65
                            dic['BraidPims9_68'] = json_obj['tags']['M-B_P_9-67']#RED TAPE METER 66
                            dic['BraidPims9_69'] = json_obj['tags']['M-B_P_9-68'] #RED TAPE METER 67
                            dic['BraidPims9_70'] = json_obj['tags']['M-B_P_9-69'] #RED TAPE METER 68
                            dic['BraidPims9_71'] = json_obj['tags']['M-B_P_9-70'] #RED TAPE METER 69
                            dic['BraidPims9_72'] = json_obj['tags']['M-B_P_9-71'] #RED TAPE METER 70
                            dic['BraidPims9_73'] = json_obj['tags']['M-B_P_9-72'] #RED TAPE METER 71
                            dic['BraidPims9_74'] = json_obj['tags']['M-B_P_9-73'] #RED TAPE METER 72
                            dic['BraidPims9_75'] = json_obj['tags']['M-B_P_9-74'] #RED TAPE METER 73
                            dic['BraidPims9_76'] = json_obj['tags']['M-B_P_9-75'] #RED TAPE METER 74
                            dic['BraidPims9_77'] = json_obj['tags']['M-B_P_9-76'] #RED TAPE METER 75
                            dic['BraidPims9_78'] = json_obj['tags']['M-B_P_9-77'] #RED TAPE METER 76
                            dic['BraidPims9_79'] = json_obj['tags']['M-B_P_9-78'] #RED TAPE METER 77
                            dic['BraidPims9_80'] = json_obj['tags']['M-B_P_9-79'] #RED TAPE METER 78
                            dic['BraidPims9_81'] = json_obj['tags']['M-B_P_9-80'] #RED TAPE METER 79
                            dic['BraidPims9_82'] = json_obj['tags']['M-B_P_9-81'] #RED TAPE METER 80
                            '''

                            dic['BraidProd1_1'] = dic['Braid1_1'] #PIR
                            dic['BraidProd1_2'] = dic['Braid1_2'] #Operator Name
                            dic['BraidProd1_3'] = fixedInt(json_obj['M-B_H_1-58']) #Actual Line Speed
                            dic['BraidProd1_4'] = not findBool(dic['BraidStop1_2']) #sys Run Boolean Bit
                            dic['BraidProd1_5'] = fixedInt(json_obj['M-B_H_1-57']) #Prod Time coming from prod tag
                            dic['BraidProd1_6'] = dic['BraidPims1_1'] #Drum In # coming from prod tag
                            dic['BraidProd1_7'] = dic['BraidPims1_2'] #Drum Out #coming from prod tag
                            ...
                            dic['BraidProd2_1'] = dic['Braid2_1'] #PIR
                            dic['BraidProd2_2'] = dic['Braid2_2'] #Operator Name
                            dic['BraidProd2_3'] = fixedInt(json_obj['M-B_H_2-58']) #Actual Line Speed
                            dic['BraidProd2_4'] = not findBool(dic['BraidStop2_2']) #sys Run Boolean Bit
                            dic['BraidProd2_5'] = fixedInt(json_obj['M-B_H_2-57']) #Prod Time coming from prod tag
                            dic['BraidProd2_6'] = dic['BraidPims2_1'] #Drum In # coming from prod tag
                            dic['BraidProd2_7'] = dic['BraidPims2_2'] #Drum Out #coming from prod tag
                            dic['BraidProd2_8'] = fixedInt(json_obj['M-B_H_2-5']) #Process Start Bit
                            dic['BraidProd2_9'] = fixedInt(json_obj['M-B_H_2-59']) #run bit

                            dic['BraidProd3_1'] = dic['Braid3_1'] #PIR
                            dic['BraidProd3_2'] = dic['Braid3_2'] #Operator Name
                            dic['BraidProd3_3'] = fixedInt(json_obj['M-B_H_3-58']) #Actual Line Speed
                            dic['BraidProd3_4'] = not findBool(dic['BraidStop3_2']) #sys Run Boolean Bit
                            dic['BraidProd3_5'] = fixedInt(json_obj['M-B_H_3-57']) #Prod Time coming from prod tag
                            dic['BraidProd3_6'] = dic['BraidPims3_1'] #Drum In # coming from prod tag
                            dic['BraidProd3_7'] = dic['BraidPims3_2'] #Drum Out #coming from prod tag
                            dic['BraidProd3_8'] = fixedInt(json_obj['M-B_H_3-5']) #Process Start Bit
                            dic['BraidProd3_9'] = fixedInt(json_obj['M-B_H_3-59']) #run bit

                            dic['BraidProd4_1'] = dic['Braid4_1'] #PIR
                            dic['BraidProd4_2'] = dic['Braid4_2'] #Operator Name
                            dic['BraidProd4_3'] = fixedInt(json_obj['M-B_H_4-58']) #Actual Line Speed
                            dic['BraidProd4_4'] = not findBool(dic['BraidStop4_2']) #sys Run Boolean Bit
                            dic['BraidProd4_5'] = fixedInt(json_obj['M-B_H_4-57']) #Prod Time coming from prod tag
                            dic['BraidProd4_6'] = dic['BraidPims4_1'] #Drum In # coming from prod tag
                            dic['BraidProd4_7'] = dic['BraidPims4_2'] #Drum Out #coming from prod tag
                            dic['BraidProd4_8'] = fixedInt(json_obj['M-B_H_4-5']) #Process Start Bit
                            dic['BraidProd4_9'] = fixedInt(json_obj['M-B_H_4-59']) #run bit

                            dic['BraidProd5_1'] = dic['Braid5_1'] #PIR
                            dic['BraidProd5_2'] = dic['Braid5_2'] #Operator Name
                            dic['BraidProd5_3'] = fixedInt(json_obj['M-B_H_5-58']) #Actual Line Speed
                            dic['BraidProd5_4'] = not findBool(dic['BraidStop5_2']) #sys Run Boolean Bit
                            dic['BraidProd5_5'] = fixedInt(json_obj['M-B_H_5-57']) #Prod Time coming from prod tag
                            dic['BraidProd5_6'] = dic['BraidPims5_1'] #Drum In # coming from prod tag
                            dic['BraidProd5_7'] = dic['BraidPims5_2'] #Drum Out #coming from prod tag
                            dic['BraidProd5_8'] = fixedInt(json_obj['M-B_H_5-5']) #Process Start Bit
                            dic['BraidProd5_9'] = fixedInt(json_obj['M-B_H_5-59']) #run bit

                            dic['BraidProd6_1'] = dic['Braid6_1'] #PIR
                            dic['BraidProd6_2'] = dic['Braid6_2'] #Operator Name
                            dic['BraidProd6_3'] = fixedInt(json_obj['M-B_H_6-58']) #Actual Line Speed
                            dic['BraidProd6_4'] = not findBool(dic['BraidStop6_2']) #sys Run Boolean Bit
                            dic['BraidProd6_5'] = fixedInt(json_obj['M-B_H_6-57']) #Prod Time coming from prod tag
                            dic['BraidProd6_6'] = dic['BraidPims6_1'] #Drum In # coming from prod tag
                            dic['BraidProd6_7'] = dic['BraidPims6_2'] #Drum Out #coming from prod tag
                            dic['BraidProd6_8'] = fixedInt(json_obj['M-B_H_6-5']) #Process Start Bit
                            dic['BraidProd6_9'] = fixedInt(json_obj['M-B_H_6-59']) #run bit

                            dic['BraidProd7_1'] = dic['Braid7_1'] #PIR
                            dic['BraidProd7_2'] = dic['Braid7_2'] #Operator Name
                            dic['BraidProd7_3'] = fixedInt(json_obj['M-B_H_7-58']) #Actual Line Speed
                            dic['BraidProd7_4'] = not findBool(dic['BraidStop7_2']) #sys Run Boolean Bit
                            dic['BraidProd7_5'] = fixedInt(json_obj['M-B_H_7-57']) #Prod Time coming from prod tag
                            dic['BraidProd7_6'] = dic['BraidPims7_1'] #Drum In # coming from prod tag
                            dic['BraidProd7_7'] = dic['BraidPims7_2'] #Drum Out #coming from prod tag
                            dic['BraidProd7_8'] = fixedInt(json_obj['M-B_H_7-5']) #Process Start Bit
                            dic['BraidProd7_9'] = fixedInt(json_obj['M-B_H_7-59']) #run bit

                            dic['BraidProd8_1'] = dic['Braid8_1'] #PIR
                            dic['BraidProd8_2'] = dic['Braid8_2'] #Operator Name
                            dic['BraidProd8_3'] = fixedInt(json_obj['M-B_H_8-58']) #Actual Line Speed
                            dic['BraidProd8_4'] = not findBool(dic['BraidStop8_2']) #sys Run Boolean Bit
                            dic['BraidProd8_5'] = fixedInt(json_obj['M-B_H_8-57']) #Prod Time coming from prod tag
                            dic['BraidProd8_6'] = dic['BraidPims8_1'] #Drum In # coming from prod tag
                            dic['BraidProd8_7'] = dic['BraidPims8_2'] #Drum Out #coming from prod tag
                            dic['BraidProd8_8'] = fixedInt(json_obj['M-B_H_8-5']) #Process Start Bit
                            dic['BraidProd8_9'] = fixedInt(json_obj['M-B_H_8-59']) #run bit
                            '''
                            dic['BraidProd9_1'] = dic['Braid9_1'] #PIR
                            dic['BraidProd9_2'] = dic['Braid9_2'] #Operator Name
                            dic['BraidProd9_3'] = fixedInt(json_obj['tags']['M-B_H_9-58']) #Actual Line Speed
                            dic['BraidProd9_4'] = not findBool(dic['BraidStop9_2']) #sys Run Boolean Bit
                            dic['BraidProd9_5'] = fixedInt(json_obj['tags']['M-B_H_9-57']) #Prod Time coming from prod tag
                            dic['BraidProd9_6'] = dic['BraidPims9_1'] #Drum In # coming from prod tag
                            dic['BraidProd9_7'] = dic['BraidPims9_2'] #Drum Out #coming from prod tag
                            dic['BraidProd9_8'] = fixedInt(json_obj['tags']['M-B_H_9-59']) #Process Start Bit
                            '''
...
def polling_thread():
    ...
    client = mqttClient.Client("MQTT128742")
    client.username_pw_set("", "")
...
def sql():
    try:
        ...
        sql = "INSERT INTO braiderreport1 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid1_1']), str(dic['Braid1_2']), int(dic['Braid1_3']), int(dic['Braid1_4']), findFloat(float(dic['Braid1_5'])), findFloat(float(dic['Braid1_6'])), findFloat(float(dic['Braid1_7'])), findFloat(float(dic['Braid1_8'])), findFloat(float(dic['Braid1_9'])), findFloat(float(dic['Braid1_10'])), findFloat(float(dic['Braid1_11'])), findFloat(float(dic['Braid1_12'])))
        mycursor.execute(sql, val)
        mydb.commit()
        
        sql = "INSERT INTO braiderreport2 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid2_1']), str(dic['Braid2_2']), int(dic['Braid2_3']), int(dic['Braid2_4']), findFloat(float(dic['Braid2_5'])), findFloat(float(dic['Braid2_6'])), findFloat(float(dic['Braid2_7'])), findFloat(float(dic['Braid2_8'])), findFloat(float(dic['Braid2_9'])), findFloat(float(dic['Braid2_10'])), findFloat(float(dic['Braid2_11'])), findFloat(float(dic['Braid2_12'])))
        mycursor.execute(sql, val)
        mydb.commit()

        sql = "INSERT INTO braiderreport3 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid3_1']), str(dic['Braid3_2']), int(dic['Braid3_3']), int(dic['Braid3_4']), findFloat(float(dic['Braid3_5'])), findFloat(float(dic['Braid3_6'])), findFloat(float(dic['Braid3_7'])), findFloat(float(dic['Braid3_8'])), findFloat(float(dic['Braid3_9'])), findFloat(float(dic['Braid3_10'])), findFloat(float(dic['Braid3_11'])), findFloat(float(dic['Braid3_12'])))
        mycursor.execute(sql, val)
        mydb.commit()

        sql = "INSERT INTO braiderreport4 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sql = "INSERT INTO braiderreport5 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid5_1']), str(dic['Braid5_2']), int(dic['Braid5_3']), int(dic['Braid5_4']), findFloat(float(dic['Braid5_5'])), findFloat(float(dic['Braid5_6'])), findFloat(float(dic['Braid5_7'])), findFloat(float(dic['Braid5_8'])), findFloat(float(dic['Braid5_9'])), findFloat(float(dic['Braid5_10'])), findFloat(float(dic['Braid5_11'])), findFloat(float(dic['Braid5_12'])))
        mycursor.execute(sql, val)
        mydb.commit()

        sql = "INSERT INTO braiderreport6 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid6_1']), str(dic['Braid6_2']), int(dic['Braid6_3']), int(dic['Braid6_4']), findFloat(float(dic['Braid6_5'])), findFloat(float(dic['Braid6_6'])), findFloat(float(dic['Braid6_7'])), findFloat(float(dic['Braid6_8'])), findFloat(float(dic['Braid6_9'])), findFloat(float(dic['Braid6_10'])), findFloat(float(dic['Braid6_11'])), findFloat(float(dic['Braid6_12'])))
        mycursor.execute(sql, val)
        mydb.commit()

        sql = "INSERT INTO braiderreport7 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid7_1']), str(dic['Braid7_2']), int(dic['Braid7_3']), int(dic['Braid7_4']), findFloat(float(dic['Braid7_5'])), findFloat(float(dic['Braid7_6'])), findFloat(float(dic['Braid7_7'])), findFloat(float(dic['Braid7_8'])), findFloat(float(dic['Braid7_9'])), findFloat(float(dic['Braid7_10'])), findFloat(float(dic['Braid7_11'])), findFloat(float(dic['Braid7_12'])))
        mycursor.execute(sql, val)
        mydb.commit()

        sql = "INSERT INTO braiderreport8 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid8_1']), str(dic['Braid8_2']), int(dic['Braid8_3']), int(dic['Braid8_4']), findFloat(float(dic['Braid8_5'])), findFloat(float(dic['Braid8_6'])), findFloat(float(dic['Braid8_7'])), findFloat(float(dic['Braid8_8'])), findFloat(float(dic['Braid8_9'])), findFloat(float(dic['Braid8_10'])), findFloat(float(dic['Braid8_11'])), findFloat(float(dic['Braid8_12'])))
        mycursor.execute(sql, val)
        mydb.commit()
        ...
        if(globalBS.tempBraidProd1 != findBool(dic['BraidProd1_8'])):
                ...
                if(findBool(dic['BraidProd1_8']) == False):
                        ...
                        val = (str(dic['BraidProd1_1']), str(dic['BraidProd1_2']), globalBS.tempBraidDT1, findFloat(float(dic['BraidProd1_3'])),  int(globalBS.tempBraidElapsed1) , int(dic['BraidProd1_6']), int(dic['BraidProd1_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd2 != findBool(dic['BraidProd2_8'])):
                ...
                if(findBool(dic['BraidProd2_8']) == False):
                        ...
                        val = (str(dic['BraidProd2_1']), str(dic['BraidProd2_2']), globalBS.tempBraidDT2, findFloat(float(dic['BraidProd2_3'])),  int(globalBS.tempBraidElapsed2) , int(dic['BraidProd2_6']), int(dic['BraidProd2_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd3 != findBool(dic['BraidProd3_8'])):
                ...
                if(findBool(dic['BraidProd3_8']) == False):
                        ...
                        val = (str(dic['BraidProd3_1']), str(dic['BraidProd3_2']), globalBS.tempBraidDT3, findFloat(float(dic['BraidProd3_3'])),  int(globalBS.tempBraidElapsed3) , int(dic['BraidProd3_6']), int(dic['BraidProd3_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd4 != findBool(dic['BraidProd4_8'])):
                ...
                if(findBool(dic['BraidProd4_8']) == False):
                        ...
                        val = (str(dic['BraidProd4_1']), str(dic['BraidProd4_2']), globalBS.tempBraidDT4, findFloat(float(dic['BraidProd4_3'])),  int(globalBS.tempBraidElapsed4) , int(dic['BraidProd4_6']), int(dic['BraidProd4_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd5 != findBool(dic['BraidProd5_8'])):
                ...
                if(findBool(dic['BraidProd5_8']) == False):
                        ...
                        val = (str(dic['BraidProd5_1']), str(dic['BraidProd5_2']), globalBS.tempBraidDT5, findFloat(float(dic['BraidProd5_3'])),  int(globalBS.tempBraidElapsed5) , int(dic['BraidProd5_6']), int(dic['BraidProd5_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd6 != findBool(dic['BraidProd6_8'])):
                ...
                if(findBool(dic['BraidProd6_8']) == False):
                        ...
                        val = (str(dic['BraidProd6_1']), str(dic['BraidProd6_2']), globalBS.tempBraidDT6, findFloat(float(dic['BraidProd6_3'])),  int(globalBS.tempBraidElapsed6) , int(dic['BraidProd6_6']), int(dic['BraidProd6_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd7 != findBool(dic['BraidProd7_8'])):
                ...
                if(findBool(dic['BraidProd7_8']) == False):
                        ...
                        val = (str(dic['BraidProd7_1']), str(dic['BraidProd7_2']), globalBS.tempBraidDT7, findFloat(float(dic['BraidProd7_3'])),  int(globalBS.tempBraidElapsed7) , int(dic['BraidProd7_6']), int(dic['BraidProd7_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempBraidProd8 != findBool(dic['BraidProd8_8'])):
                ...
                if(findBool(dic['BraidProd8_8']) == False):
                        ...
                        val = (str(dic['BraidProd8_1']), str(dic['BraidProd8_2']), globalBS.tempBraidDT8, findFloat(float(dic['BraidProd8_3'])),  int(globalBS.tempBraidElapsed8) , int(dic['BraidProd8_6']), int(dic['BraidProd8_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()


        '''
        sql = "INSERT INTO braiderreport9 ( pir , operator_name , deck_set_speed , deck_act_speed , prod_meter , tot_run_hours , blower_set_temp , blower_act_temp , n2_set_temp , n2_inlet_temp , n2_outlet_temp , n2_pressure ) VALUES (%s, %s, %s ,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = (str(dic['Braid9_1']), str(dic['Braid9_2']), int(dic['Braid9_3']), int(dic['Braid9_4']), findFloat(float(dic['Braid9_5'])), int(dic['Braid9_6']), findFloat(float(dic['Braid9_7'])), findFloat(float(dic['Braid9_8'])), findFloat(float(dic['Braid9_9'])), findFloat(float(dic['Braid9_10'])), findFloat(float(dic['Braid9_11'])), findFloat(float(dic['Braid9_12'])))
        mycursor.execute(sql, val)
        mydb.commit()
        
        if(globalBS.tempBraid1_1 != findBool(dic['Alarm1_1'])):
        sql = "INSERT INTO braidprodtimer ( machine_id , process_id , status ) VALUES (%s, %s, %s)"
        val = (1, findBool(dic['BraidProd1_8']), findBool(dic['BraidProd1_8']))
        mycursor.execute(sql, val)
        mydb.commit()



        sql = "INSERT INTO braidproduction1 ( pir , operator_name , actual_line_speed, sys_run, prod_time, drum_in, drum_out ) VALUES (%s, %s, %s ,%s,%s,%s,%s)"
        val = (str(dic['BraidProd1_1']), str(dic['BraidProd1_2']), findFloat(float(dic['BraidProd1_3'])), dic['BraidProd1_4'], int(dic['BraidProd1_5']), int(dic['BraidProd1_6']), int(dic['BraidProd1_7']))
        mycursor.execute(sql, val)
        mydb.commit()
        print("production data dumped: Testing")
        '''
        ...
        '''
        if(globalBS.tempBraid9_1 != findBool(dic['Alarm9_1'])):
                globalBS.tempBraid9_1 = findBool(dic['Alarm9_1'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 1, 'MACHINE EMERGENCY PRESSED', findBool(dic['Alarm9_1']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_2 != findBool(dic['Alarm9_2'])):
                globalBS.tempBraid9_2 = findBool(dic['Alarm9_2'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 2, 'DOOR NOT CLOSED', findBool(dic['Alarm9_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_3 != findBool(dic['Alarm9_3'])):
                globalBS.tempBraid9_3 = findBool(dic['Alarm9_3'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 3, 'CLOSE FRONT RIGHT DOOR AND PRESS RESET', findBool(dic['Alarm9_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_4 != findBool(dic['Alarm9_4'])):
                globalBS.tempBraid9_4 = findBool(dic['Alarm9_4'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 4, 'CLOSE FRONT LEFT DOOR AND PRESS RESET', findBool(dic['Alarm9_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_5 != findBool(dic['Alarm9_5'])):
                globalBS.tempBraid9_5 = findBool(dic['Alarm9_5'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 5, 'CLOSE BACK RIGHT DOOR AND PRESS RESET', findBool(dic['Alarm9_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_6 != findBool(dic['Alarm9_6'])):
                globalBS.tempBraid9_6 = findBool(dic['Alarm9_6'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 6, 'CLOSE BACK LEFT DOOR AND PRESS RESET', findBool(dic['Alarm9_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_7 != findBool(dic['Alarm9_7'])):
                globalBS.tempBraid9_7 = findBool(dic['Alarm9_7'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 7, 'BOBBIN EMPTY D1 INNER ACTIVATED', findBool(dic['Alarm9_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_8 != findBool(dic['Alarm9_8'])):
                globalBS.tempBraid9_8 = findBool(dic['Alarm9_8'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 8, 'BOBBIN EMPTY D1 OUTER ACTIVATED', findBool(dic['Alarm9_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_9 != findBool(dic['Alarm9_9'])):
                globalBS.tempBraid9_9 = findBool(dic['Alarm9_9'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 9, 'BOBBIN EMPTY D2 INNER ACTIVATED', findBool(dic['Alarm9_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_10 != findBool(dic['Alarm9_10'])):
                globalBS.tempBraid9_10 = findBool(dic['Alarm9_10'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 10, 'BOBBIN EMPTY D2 OUTER ACTIVATED', findBool(dic['Alarm9_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_11 != findBool(dic['Alarm9_11'])):
                globalBS.tempBraid9_11 = findBool(dic['Alarm9_11'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 11, 'WIRE BREAK D1 BACK ACTIVATED', findBool(dic['Alarm9_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_12 != findBool(dic['Alarm9_12'])):
                globalBS.tempBraid9_12 = findBool(dic['Alarm9_12'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 12, 'WIRE BREAK D1 FRONT ACTIVATED', findBool(dic['Alarm9_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_13 != findBool(dic['Alarm9_13'])):
                globalBS.tempBraid9_13 = findBool(dic['Alarm9_13'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 13, 'WIRE BREAK D2 BACK ACTIVATED', findBool(dic['Alarm9_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_14 != findBool(dic['Alarm9_14'])):
                globalBS.tempBraid9_14 = findBool(dic['Alarm9_14'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 14, 'WIRE BREAK D2 OUTER ACTIVATED', findBool(dic['Alarm9_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_15 != findBool(dic['Alarm9_15'])):
                globalBS.tempBraid9_15 = findBool(dic['Alarm9_15'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 15, 'OIL LEVEL D2 SENSOR ACTIVATED', findBool(dic['Alarm9_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_16 != findBool(dic['Alarm9_16'])):
                globalBS.tempBraid9_16 = findBool(dic['Alarm9_16'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 16, 'MPCB TRIP ACTIVATED', findBool(dic['Alarm9_16']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_17 != findBool(dic['Alarm9_17'])):
                globalBS.tempBraid9_17 = findBool(dic['Alarm9_17'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 17, 'RUNNING PLY SENSOR ACTIVATED', findBool(dic['Alarm9_17']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_18 != findBool(dic['Alarm9_18'])):
                globalBS.tempBraid9_18 = findBool(dic['Alarm9_18'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 18, 'OIL LEVEL D1 SENSOR ACTIVATED', findBool(dic['Alarm9_18']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_19 != findBool(dic['Alarm9_19'])):
                globalBS.tempBraid9_19 = findBool(dic['Alarm9_19'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 19, 'TAKE UP EMERGENGY ACTIVATED', findBool(dic['Alarm9_19']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_20 != findBool(dic['Alarm9_20'])):
                globalBS.tempBraid9_20 = findBool(dic['Alarm9_20'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 20, 'WIRE BREAK D1 TOP ACTIVATED', findBool(dic['Alarm9_20']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempBraid9_21 != findBool(dic['Alarm9_21'])):
                globalBS.tempBraid9_21 = findBool(dic['Alarm9_21'])
                sql = "INSERT INTO braidalarm9 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], 21, 'WIRE BREAK D2 TOP ACTIVATED', findBool(dic['Alarm9_21']))
                mycursor.execute(sql, val)
                mydb.commit()
                '''
        ...
        '''
        if(globalBS.tempBraidStop9 != findBool(dic['BraidStop9_2'])):
                globalBS.tempBraidStop9 = findBool(dic['BraidStop9_2'])
                if(dic['BraidStop9_1'] == '1'):
                        dic['BraidStopMessage9'] = "Carrier Problem"
                elif(dic['BraidStop9_1'] == '2'):
                        dic['BraidStopMessage9'] = "Joint Bobbin"
                elif(dic['BraidStop9_1'] == '3'):
                        dic['BraidStopMessage9'] = "Liner Cut"
                elif(dic['BraidStop9_1'] == '4'):
                        dic['BraidStopMessage9'] = "Mandrel Broken"
                elif(dic['BraidStop9_1'] == '5'):
                        dic['BraidStopMessage9'] = "Pitch Problem"
                elif(dic['BraidStop9_1'] == '6'):
                        dic['BraidStopMessage9'] = "Ply Cut Joint"
                elif(dic['BraidStop9_1'] == '7'):
                        dic['BraidStopMessage9'] = "Power Cut"
                elif(dic['BraidStop9_1'] == '8'):
                        dic['BraidStopMessage9'] = "Push Back"
                elif(dic['BraidStop9_1'] == '9'):
                        dic['BraidStopMessage9'] = "Setting Joint"
                elif(dic['BraidStop9_1'] == '10'):
                        dic['BraidStopMessage9'] = "Tube Joint"
                elif(dic['BraidStop9_1'] == '11'):
                        dic['BraidStopMessage9'] = "Wire Break"
                elif(dic['BraidStop9_1'] == '12'):
                        dic['BraidStopMessage9'] = "Wire Loose"
                elif(dic['BraidStop9_1'] == '13'):
                        dic['BraidStopMessage9'] = "Over Heating"
                elif(dic['BraidStop9_1'] == '14'):
                        dic['BraidStopMessage9'] = "M/C Stop"
                elif(dic['BraidStop9_1'] == '15'):
                        dic['BraidStopMessage9'] = "No Tube"
                elif(dic['BraidStop9_1'] == '16'):
                        dic['BraidStopMessage9'] = "No Braider Wire"
                elif(dic['BraidStop9_1'] == '17'):
                        dic['BraidStopMessage9'] = "Break Down"
                elif(dic['BraidStop9_1'] == '18'):
                        dic['BraidStopMessage9'] = "PM"
                elif(dic['BraidStop9_1'] == '19'):
                        dic['BraidStopMessage9'] = "No Plan"
                elif(dic['BraidStop9_1'] == '20'):
                        dic['BraidStopMessage9'] = "Setting Time"
                

                sql = "INSERT INTO braidstoppage9 ( pir, operator_name, stoppage_id, stoppage_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Braid9_1'], dic['Braid9_2'], int(dic['BraidStop9_1']), dic['BraidStopMessage9'], findBool(dic['BraidStop9_2']))
                mycursor.execute(sql, val)
                mydb.commit()
                '''
        ...
        val = ( int(dic['BraidPims3_1']), int(dic['BraidPims3_2']),
        ...
        val = ( int(dic['BraidPims4_1']), int(dic['BraidPims4_2']),
        ...
        val = ( int(dic['BraidPims5_1']), int(dic['BraidPims5_2']),
        ...
        val = ( int(dic['BraidPims6_1']), int(dic['BraidPims6_2']),
        ...
        val = ( int(dic['BraidPims7_1']), int(dic['BraidPims7_2']),
        ...
        val = ( int(dic['BraidPims8_1']), int(dic['BraidPims8_2']),
        ...
        mydb.commit()
        '''
        sql = "INSERT INTO braiderpims9 ( b9_drum_in , b9_drum_out , b9_rtm_1 , b9_rtm_2 , b9_rtm_3 , b9_rtm_4 , b9_rtm_5, b9_rtm_6, b9_rtm_7, b9_rtm_8, b9_rtm_9, b9_rtm_10, b9_rtm_11 , b9_rtm_12 , b9_rtm_13 , b9_rtm_14 , b9_rtm_15, b9_rtm_16, b9_rtm_17, b9_rtm_18, b9_rtm_19, b9_rtm_20, b9_rtm_21 , b9_rtm_22 , b9_rtm_23 , b9_rtm_24 , b9_rtm_25, b9_rtm_26, b9_rtm_27, b9_rtm_28, b9_rtm_29, b9_rtm_30, b9_rtm_31 , b9_rtm_32 , b9_rtm_33 , b9_rtm_34 , b9_rtm_35, b9_rtm_36, b9_rtm_37, b9_rtm_38, b9_rtm_39, b9_rtm_40, b9_rtm_41 , b9_rtm_42 , b9_rtm_43 , b9_rtm_44 , b9_rtm_45, b9_rtm_46, b9_rtm_47, b9_rtm_48, b9_rtm_49, b9_rtm_50, b9_rtm_51 , b9_rtm_52 , b9_rtm_53 , b9_rtm_54 , b9_rtm_55, b9_rtm_56, b9_rtm_57, b9_rtm_58, b9_rtm_59, b9_rtm_60, b9_rtm_61 , b9_rtm_62 , b9_rtm_63 , b9_rtm_64 , b9_rtm_65, b9_rtm_66, b9_rtm_67, b9_rtm_68, b9_rtm_69, b9_rtm_70, b9_rtm_71 , b9_rtm_72 , b9_rtm_73 , b9_rtm_74 , b9_rtm_75, b9_rtm_76, b9_rtm_77, b9_rtm_78, b9_rtm_79, b9_rtm_80) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = ( int(dic['BraidPims9_1']), int(dic['BraidPims9_2']),
                findFloat(float(dic['BraidPims9_3'])), findFloat(float(dic['BraidPims9_4'])),
                findFloat(float(dic['BraidPims9_5'])), findFloat(float(dic['BraidPims9_6'])), 
                findFloat(float(dic['BraidPims9_7'])), findFloat(float(dic['BraidPims9_8'])), 
                findFloat(float(dic['BraidPims9_9'])), findFloat(float(dic['BraidPims9_10'])), 
                findFloat(float(dic['BraidPims9_11'])), findFloat(float(dic['BraidPims9_12'])), 
                findFloat(float(dic['BraidPims9_13'])), findFloat(float(dic['BraidPims9_14'])), 
                findFloat(float(dic['BraidPims9_15'])), findFloat(float(dic['BraidPims9_16'])), 
                findFloat(float(dic['BraidPims9_17'])), findFloat(float(dic['BraidPims9_18'])), 
                findFloat(float(dic['BraidPims9_19'])), findFloat(float(dic['BraidPims9_20'])), 
                findFloat(float(dic['BraidPims9_21'])), findFloat(float(dic['BraidPims9_22'])), 
                findFloat(float(dic['BraidPims9_23'])), findFloat(float(dic['BraidPims9_24'])), 
                findFloat(float(dic['BraidPims9_25'])), findFloat(float(dic['BraidPims9_26'])), 
                findFloat(float(dic['BraidPims9_27'])), findFloat(float(dic['BraidPims9_28'])), 
                findFloat(float(dic['BraidPims9_29'])), findFloat(float(dic['BraidPims9_30'])), 
                findFloat(float(dic['BraidPims9_31'])), findFloat(float(dic['BraidPims9_32'])), 
                findFloat(float(dic['BraidPims9_33'])), findFloat(float(dic['BraidPims9_34'])),
                findFloat(float(dic['BraidPims9_35'])), findFloat(float(dic['BraidPims9_36'])), 
                findFloat(float(dic['BraidPims9_37'])), findFloat(float(dic['BraidPims9_38'])), 
                findFloat(float(dic['BraidPims9_39'])), findFloat(float(dic['BraidPims9_40'])), 
                findFloat(float(dic['BraidPims9_41'])), findFloat(float(dic['BraidPims9_42'])), 
                findFloat(float(dic['BraidPims9_43'])), findFloat(float(dic['BraidPims9_44'])), 
                findFloat(float(dic['BraidPims9_45'])), findFloat(float(dic['BraidPims9_46'])), 
                findFloat(float(dic['BraidPims9_47'])), findFloat(float(dic['BraidPims9_48'])), 
                findFloat(float(dic['BraidPims9_49'])), findFloat(float(dic['BraidPims9_50'])), 
                findFloat(float(dic['BraidPims9_51'])), findFloat(float(dic['BraidPims9_52'])), 
                findFloat(float(dic['BraidPims9_53'])), findFloat(float(dic['BraidPims9_54'])), 
                findFloat(float(dic['BraidPims9_55'])), findFloat(float(dic['BraidPims9_56'])), 
                findFloat(float(dic['BraidPims9_57'])), findFloat(float(dic['BraidPims9_58'])), 
                findFloat(float(dic['BraidPims9_59'])), findFloat(float(dic['BraidPims9_60'])), 
                findFloat(float(dic['BraidPims9_61'])), findFloat(float(dic['BraidPims9_62'])), 
                findFloat(float(dic['BraidPims9_63'])), findFloat(float(dic['BraidPims9_64'])), 
                findFloat(float(dic['BraidPims9_65'])), findFloat(float(dic['BraidPims9_66'])), 
                findFloat(float(dic['BraidPims9_67'])), findFloat(float(dic['BraidPims9_68'])), 
                findFloat(float(dic['BraidPims9_69'])), findFloat(float(dic['BraidPims9_70'])), 
                findFloat(float(dic['BraidPims9_71'])), findFloat(float(dic['BraidPims9_72'])), 
                findFloat(float(dic['BraidPims9_73'])), findFloat(float(dic['BraidPims9_74'])), 
                findFloat(float(dic['BraidPims9_75'])), findFloat(float(dic['BraidPims9_76'])), 
                findFloat(float(dic['BraidPims9_77'])), findFloat(float(dic['BraidPims9_78'])), 
                findFloat(float(dic['BraidPims9_79'])), findFloat(float(dic['BraidPims9_80'])), 
                findFloat(float(dic['BraidPims9_81'])), findFloat(float(dic['BraidPims9_82'])))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
