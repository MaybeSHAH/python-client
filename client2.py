...
connection = connect(host='localhost', port=3307, user='root', 
                     password='', db='pims', 
...
def sql2():
    try:
        ...
        '''
        sql = "INSERT INTO extruderreport2 ( pir , operator_name , line_run_feedback , od_setpoint , od_actual , id_setpoint , id_actual, thickness_set, thickness_act, ext_rpm_set, ext_rpm_act, ext_cur_set, ext_cur_act, ext_pre_set, ext_pre_act, line_mpm_set, line_mpm_act, prod_meter, head_temp_sp, head_temp_act, screw_temp_sp, screw_temp_act, zone2_temp_sp, zone2_temp_act, zone3_temp_sp, zone3_temp_act, mesh, no_linear_cut, tube_hot_od_setvalue, tube_hot_od_actvalue, tube_cold_od_setvalue, tube_cold_od_actvalue, pin_set_value, pin_act_value, die_set_value, die_act_value, drum_out_no, amps, screw_rpm, line_speed, batches_used, extruder_qty, temp_head_set_value, temp_head_act_value, temp_zone1_set_value, temp_zone1_act_value, temp_zone2_set_value, temp_zone2_act_value, temp_zone3_set_value, temp_zone3_act_value, temp_zone4_set_value, temp_zone4_act_value, temp_zone5_set_value, temp_zone5_act_value, vaccum_set_value, vaccum_act_value, wall_thick_spec, wall_thick_act, ecc_set_value, ecc_act_value, qa_approval) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
