...
class globalBS():
        ...
        tempExtProd1 = tempExtProd2 = tempExtProd3 = tempExtProd4 = False
                        ...
                        if(count2 == 12):
                                ...
                                if(is_valid_json(json_data)):
                                        ...
                                        if(findBool(json_obj['connected'])):
                                                ...
                                                dic['Mandrel3_3'] = json_obj['tags']['M-M_R_3-2'] #PROGRAM NAME
                                                dic['Mandrel3_4'] = json_obj['tags']['M-M_R_3-3'] #MANDREL ID 
                                                dic['Mandrel3_5'] = json_obj['tags']['M-M_R_3-4'] #ACTUAL OD
                                                dic['Mandrel3_6'] = json_obj['tags']['M-M_R_3-5'] #MINIMUM OD 
                                                dic['Mandrel3_7'] = json_obj['tags']['M-M_R_3-6'] #MAXMUM OD
                                                dic['Mandrel3_8'] = json_obj['tags']['M-M_R_3-7'] #FIXED BLOCK SET TEMP
                                                dic['Mandrel3_9'] = json_obj['tags']['M-M_R_3-8'] #MOVABLE BLOCK SET TEMP
                                                dic['Mandrel3_10'] = json_obj['tags']['M-M_R_3-9'] #FIXED BLOCK ACTUAL TEMP
                                                dic['Mandrel3_11'] = json_obj['tags']['M-M_R_3-10'] #MOVABLE BLOCK ACTUAL TEMP
                                                '''
                                                ...
                                                dic['Extruder1_5'] = fixedInt(json_obj['M-E_R_1-4']) #OD ACTUAL
                                                dic['Extruder1_6'] = fixedInt(json_obj['M-E_R_1-5']) #ID SETPOINT
                                                dic['Extruder1_7'] = fixedInt(json_obj['M-E_R_1-6']) #ID ACTUAL
                                                dic['Extruder1_8'] = fixedInt(json_obj['M-E_R_1-7']) #THICKNESS SET
                                                ...
                                                '''
                                                dic['Extruder2_1'] = json_obj['tags']['M-E_R_2-0'] #PIR
                                                dic['Extruder2_2'] = json_obj['tags']['M-E_R_2-1'] #OPERATOR NAME
                                                dic['Extruder2_3'] = json_obj['tags']['M-E_R_2-2'] #LINE RUN FEEDBACK
                                                dic['Extruder2_4'] = json_obj['tags']['M-E_R_2-3'] #OD SETPOINT
                                                dic['Extruder2_5'] = json_obj['tags']['M-E_R_2-4'] #OD ACTUAL
                                                dic['Extruder2_6'] = json_obj['tags']['M-E_R_2-5'] #ID SETPOINT
                                                dic['Extruder2_7'] = json_obj['tags']['M-E_R_2-6'] #ID ACTUAL
                                                dic['Extruder2_8'] = json_obj['tags']['M-E_R_2-7'] #THICKNESS SET
                                                dic['Extruder2_9'] = json_obj['tags']['M-E_R_2-8'] #THICKNESS ACT
                                                dic['Extruder2_10'] = json_obj['tags']['M-E_R_2-9'] #EXTRUDER RPM SET
                                                dic['Extruder2_11'] = json_obj['tags']['M-E_R_2-10'] #EXTRUDER RPM ACT
                                                dic['Extruder2_12'] = json_obj['tags']['M-E_R_2-11'] #EXTRUDER CURRENT SET
                                                dic['Extruder2_13'] = json_obj['tags']['M-E_R_2-12'] #EXTRUDER CURRENT ACT
                                                dic['Extruder2_14'] = json_obj['tags']['M-E_R_2-13'] #EXTRUDER PRESSURE SET
                                                dic['Extruder2_15'] = json_obj['tags']['M-E_R_2-14'] #EXTRUDER PRESSURE ACT
                                                dic['Extruder2_16'] = json_obj['tags']['M-E_R_2-15'] #LINE MPM SET
                                                dic['Extruder2_17'] = json_obj['tags']['M-E_R_2-16'] #LINE MPM ACT
                                                dic['Extruder2_18'] = json_obj['tags']['M-E_R_2-17'] #PRODUCTION METER
                                                dic['Extruder2_19'] = json_obj['tags']['M-E_R_2-18'] #HEAD TEMP SETPOINT
                                                dic['Extruder2_20'] = json_obj['tags']['M-E_R_2-19'] #HEAD TEMP ACTUAL
                                                dic['Extruder2_21'] = json_obj['tags']['M-E_R_2-20'] #SCREW TEMP SETPOINT
                                                dic['Extruder2_22'] = json_obj['tags']['M-E_R_2-21'] #SCREW TEMP ACTUAL
                                                dic['Extruder2_23'] = json_obj['tags']['M-E_R_2-22'] #ZONE2 TEMP SETPOINT
                                                dic['Extruder2_24'] = json_obj['tags']['M-E_R_2-23'] #ZONE2 TEMP ACTUAL
                                                dic['Extruder2_25'] = json_obj['tags']['M-E_R_2-24'] #ZONE3 TEMP SETPOINT
                                                dic['Extruder2_26'] = json_obj['tags']['M-E_R_2-25'] #ZONE3 TEMP ACTUAL
                                                '''
                                                ...
                                                '''
                                                dic['Extruder4_1'] = json_obj['tags']['M-E_R_4-0'] #PIR
                                                dic['Extruder4_2'] = json_obj['tags']['M-E_R_4-1'] #OPERATOR NAME
                                                dic['Extruder4_3'] = json_obj['tags']['M-E_R_4-2'] #LINE RUN FEEDBACK
                                                dic['Extruder4_4'] = json_obj['tags']['M-E_R_4-3'] #OD SETPOINT
                                                dic['Extruder4_5'] = json_obj['tags']['M-E_R_4-4'] #OD ACTUAL
                                                dic['Extruder4_6'] = json_obj['tags']['M-E_R_4-5'] #ID SETPOINT
                                                dic['Extruder4_7'] = json_obj['tags']['M-E_R_4-6'] #ID ACTUAL
                                                dic['Extruder4_8'] = json_obj['tags']['M-E_R_4-7'] #THICKNESS SET
                                                dic['Extruder4_9'] = json_obj['tags']['M-E_R_4-8'] #THICKNESS ACT
                                                dic['Extruder4_10'] = json_obj['tags']['M-E_R_4-9'] #EXTRUDER RPM SET
                                                dic['Extruder4_11'] = json_obj['tags']['M-E_R_4-10'] #EXTRUDER RPM ACT
                                                dic['Extruder4_12'] = json_obj['tags']['M-E_R_4-11'] #EXTRUDER CURRENT SET
                                                dic['Extruder4_13'] = json_obj['tags']['M-E_R_4-12'] #EXTRUDER CURRENT ACT
                                                dic['Extruder4_14'] = json_obj['tags']['M-E_R_4-13'] #EXTRUDER PRESSURE SET
                                                dic['Extruder4_15'] = json_obj['tags']['M-E_R_4-14'] #EXTRUDER PRESSURE ACT
                                                dic['Extruder4_16'] = json_obj['tags']['M-E_R_4-15'] #LINE MPM SET
                                                dic['Extruder4_17'] = json_obj['tags']['M-E_R_4-16'] #LINE MPM ACT
                                                dic['Extruder4_18'] = json_obj['tags']['M-E_R_4-17'] #PRODUCTION METER
                                                dic['Extruder4_19'] = json_obj['tags']['M-E_R_4-18'] #HEAD TEMP SETPOINT
                                                dic['Extruder4_20'] = json_obj['tags']['M-E_R_4-19'] #HEAD TEMP ACTUAL
                                                dic['Extruder4_21'] = json_obj['tags']['M-E_R_4-20'] #SCREW TEMP SETPOINT
                                                dic['Extruder4_22'] = json_obj['tags']['M-E_R_4-21'] #SCREW TEMP ACTUAL
                                                dic['Extruder4_23'] = json_obj['tags']['M-E_R_4-22'] #ZONE2 TEMP SETPOINT
                                                dic['Extruder4_24'] = json_obj['tags']['M-E_R_4-23'] #ZONE2 TEMP ACTUAL
                                                dic['Extruder4_25'] = json_obj['tags']['M-E_R_4-24'] #ZONE3 TEMP SETPOINT
                                                dic['Extruder4_26'] = json_obj['tags']['M-E_R_4-25'] #ZONE3 TEMP ACTUAL
                                                '''
                                                ...
                                                dic['Vulcanizer1_4'] = fixedInt(json_obj['M-V_R_1-3']) #RAMPUP1_SETPOINT TEMP
                                                ...
                                                dic['Vulcanizer1_8'] = fixedInt(json_obj['M-V_R_1-7']) #ACTUAL TEMPERATURE
                                                ...
                                                dic['Testing1_5'] = fixedInt(json_obj['M-T_R_1-4']) #SET TEST PRESSURE
                                                ...
                                                dic['ManAlarm1_18'] = fixedInt(json_obj['M-M_A_1-17']) #MANDREL OD LOW
                                                ...
                                                '''
                                                dic['ManAlarm3_1'] = json_obj['tags']['M-M_A_3-0'] #TCI-1 PUMP MPCB TRIPPED 
                                                dic['ManAlarm3_2'] = json_obj['tags']['M-M_A_3-1'] #TCI-1 AGITATOR MPCB TRIPPED
                                                dic['ManAlarm3_3'] = json_obj['tags']['M-M_A_3-2'] #TCI-2 PUMP MPCB TRIPPED
                                                dic['ManAlarm3_4'] = json_obj['tags']['M-M_A_3-3'] #TCI=2 AGITATOR MPCB TRIPPED
                                                dic['ManAlarm3_5'] = json_obj['tags']['M-M_A_3-4'] #TAKEUP DRIVE FAULT
                                                dic['ManAlarm3_6'] = json_obj['tags']['M-M_A_3-5'] #TAKEUP DRIVE ALARM
                                                dic['ManAlarm3_7'] = json_obj['tags']['M-M_A_3-6'] #MANDREL OD HIGH LINE STOPPED
                                                dic['ManAlarm3_8'] = json_obj['tags']['M-M_A_3-7'] #MANDREL OD LOW LINE STOPPED
                                                dic['ManAlarm3_9'] = json_obj['tags']['M-M_A_3-8'] #PANEL EMERGENCY PRESSED
                                                dic['ManAlarm3_10'] = json_obj['tags']['M-M_A_3-9'] #TAKEUP EMERGENCY PRESSED
                                                dic['ManAlarm3_11'] = json_obj['tags']['M-M_A_3-10'] #SPARE 1
                                                dic['ManAlarm3_12'] = json_obj['tags']['M-M_A_3-11'] #SPARE 2
                                                dic['ManAlarm3_13'] = json_obj['tags']['M-M_A_3-12'] #SPARE 3
                                                dic['ManAlarm3_14'] = json_obj['tags']['M-M_A_3-13'] #SPARE 4
                                                dic['ManAlarm3_15'] = json_obj['tags']['M-M_A_3-14'] #SPARE 5
                                                dic['ManAlarm3_16'] = json_obj['tags']['M-M_A_3-15'] #SPARE 6
                                                dic['ManAlarm3_17'] = json_obj['tags']['M-M_A_3-16'] #MANDREL OD HIGH
                                                dic['ManAlarm3_18'] = json_obj['tags']['M-M_A_3-17'] #MANDREL OD LOW
                                                '''
                                                ...
                                                '''
                                                dic['ExtAlarm2_1'] = json_obj['tags']['M-E_A_2-0'] #THICKNESS  HIGH
                                                dic['ExtAlarm2_2'] = json_obj['tags']['M-E_A_2-1'] #THICKNESS LOW
                                                dic['ExtAlarm2_3'] = json_obj['tags']['M-E_A_2-2'] #HEAD TEMPERATURE HIGH
                                                dic['ExtAlarm2_4'] = json_obj['tags']['M-E_A_2-3'] #HEAD TEMPERATURE LOW
                                                dic['ExtAlarm2_5'] = json_obj['tags']['M-E_A_2-4'] #ZONE 2 TEMPERATURE HIGH
                                                dic['ExtAlarm2_6'] = json_obj['tags']['M-E_A_2-5'] #ZONE 2 TEMPERATURE LOW 
                                                dic['ExtAlarm2_7'] = json_obj['tags']['M-E_A_2-6'] #ZONE 3 TEMPERATURE HIGH
                                                dic['ExtAlarm2_8'] = json_obj['tags']['M-E_A_2-7'] #ZONE 3 TEMPERATURE LOW 
                                                dic['ExtAlarm2_9'] = json_obj['tags']['M-E_A_2-8'] #EXTRUDER CURRENT WARNING HIGH
                                                dic['ExtAlarm2_10'] = json_obj['tags']['M-E_A_2-9'] #EXTRUDER CURRENT ALARM HIGH
                                                dic['ExtAlarm2_11'] = json_obj['tags']['M-E_A_2-10'] #EXTRUDER PRESSURE WANING HIGH
                                                dic['ExtAlarm2_12'] = json_obj['tags']['M-E_A_2-11'] #EXTRUDER PRESSURE ALARM HIGH
                                                dic['ExtAlarm2_13'] = json_obj['tags']['M-E_A_2-12'] #OUTER DIAMETER HIGH
                                                dic['ExtAlarm2_14'] = json_obj['tags']['M-E_A_2-13'] #OUTER DIAMETER LOW
                                                dic['ExtAlarm2_15'] = json_obj['tags']['M-E_A_2-14'] #INNER DIAMETER HIGH
                                                dic['ExtAlarm2_16'] = json_obj['tags']['M-E_A_2-15'] #INNER DIAMETER LOW
                                                dic['ExtAlarm2_17'] = json_obj['tags']['M-E_A_2-16'] #TAKEUP2 END LIMIT ACTIVATED
                                                dic['ExtAlarm2_18'] = json_obj['tags']['M-E_A_2-17'] #FEEDER EMERGENCY PRESSED
                                                dic['ExtAlarm2_19'] = json_obj['tags']['M-E_A_2-18'] #RED TAPE SENSOR DETECTED
                                                dic['ExtAlarm2_20'] = json_obj['tags']['M-E_A_2-19'] #EXTRUSION MATERIAL TEMPERATURE HIGH
                                                dic['ExtAlarm2_21'] = json_obj['tags']['M-E_A_2-20'] #EXTRUSION MATERIAL TEMPERATURE LOW 
                                                dic['ExtAlarm2_22'] = json_obj['tags']['M-E_A_2-21'] #SPARE-1
                                                dic['ExtAlarm2_23'] = json_obj['tags']['M-E_A_2-22'] #SPARE-2
                                                dic['ExtAlarm2_24'] = json_obj['tags']['M-E_A_2-23'] #SPARE-3
                                                dic['ExtAlarm2_25'] = json_obj['tags']['M-E_A_2-24'] #SCREW TEMPERATURE HIGH
                                                dic['ExtAlarm2_26'] = json_obj['tags']['M-E_A_2-25'] #SCREW TEMPERATURE LOW
                                                dic['ExtAlarm2_27'] = json_obj['tags']['M-E_A_2-26'] #EXTRUDER EMERGENCY PRESSED
                                                dic['ExtAlarm2_28'] = json_obj['tags']['M-E_A_2-27'] #INPUT CATTERPULLER EMERGENCY PRESSED
                                                dic['ExtAlarm2_29'] = json_obj['tags']['M-E_A_2-28'] #OUTPUT CATTERPULLER EMERGENCY PRESSED
                                                dic['ExtAlarm2_30'] = json_obj['tags']['M-E_A_2-29'] #TAKEUP1 EMERGENCY PRESSED
                                                dic['ExtAlarm2_31'] = json_obj['tags']['M-E_A_2-30'] #TAKEUP2 EMERGENCY PRESSED
                                                dic['ExtAlarm2_32'] = json_obj['tags']['M-E_A_2-31'] #TAKEUP1 END LIMIT ACTIVATED
                                                '''
                                                ...
                                                '''
                                                dic['ExtAlarm4_1'] = json_obj['tags']['M-E_A_4-0'] #THICKNESS  HIGH
                                                dic['ExtAlarm4_2'] = json_obj['tags']['M-E_A_4-1'] #THICKNESS LOW
                                                dic['ExtAlarm4_3'] = json_obj['tags']['M-E_A_4-2'] #HEAD TEMPERATURE HIGH
                                                dic['ExtAlarm4_4'] = json_obj['tags']['M-E_A_4-3'] #HEAD TEMPERATURE LOW
                                                dic['ExtAlarm4_5'] = json_obj['tags']['M-E_A_4-4'] #ZONE 2 TEMPERATURE HIGH
                                                dic['ExtAlarm4_6'] = json_obj['tags']['M-E_A_4-5'] #ZONE 2 TEMPERATURE LOW 
                                                dic['ExtAlarm4_7'] = json_obj['tags']['M-E_A_4-6'] #ZONE 3 TEMPERATURE HIGH
                                                dic['ExtAlarm4_8'] = json_obj['tags']['M-E_A_4-7'] #ZONE 3 TEMPERATURE LOW 
                                                dic['ExtAlarm4_9'] = json_obj['tags']['M-E_A_4-8'] #EXTRUDER CURRENT WARNING HIGH
                                                dic['ExtAlarm4_10'] = json_obj['tags']['M-E_A_4-9'] #EXTRUDER CURRENT ALARM HIGH
                                                dic['ExtAlarm4_11'] = json_obj['tags']['M-E_A_4-10'] #EXTRUDER PRESSURE WANING HIGH
                                                dic['ExtAlarm4_12'] = json_obj['tags']['M-E_A_4-11'] #EXTRUDER PRESSURE ALARM HIGH
                                                dic['ExtAlarm4_13'] = json_obj['tags']['M-E_A_4-12'] #OUTER DIAMETER HIGH
                                                dic['ExtAlarm4_14'] = json_obj['tags']['M-E_A_4-13'] #OUTER DIAMETER LOW
                                                dic['ExtAlarm4_15'] = json_obj['tags']['M-E_A_4-14'] #INNER DIAMETER HIGH
                                                dic['ExtAlarm4_16'] = json_obj['tags']['M-E_A_4-15'] #INNER DIAMETER LOW
                                                dic['ExtAlarm4_17'] = json_obj['tags']['M-E_A_4-16'] #TAKEUP2 END LIMIT ACTIVATED
                                                dic['ExtAlarm4_18'] = json_obj['tags']['M-E_A_4-17'] #FEEDER EMERGENCY PRESSED
                                                dic['ExtAlarm4_19'] = json_obj['tags']['M-E_A_4-18'] #RED TAPE SENSOR DETECTED
                                                dic['ExtAlarm4_20'] = json_obj['tags']['M-E_A_4-19'] #EXTRUSION MATERIAL TEMPERATURE HIGH
                                                dic['ExtAlarm4_21'] = json_obj['tags']['M-E_A_4-20'] #EXTRUSION MATERIAL TEMPERATURE LOW 
                                                dic['ExtAlarm4_22'] = json_obj['tags']['M-E_A_4-21'] #SPARE-1
                                                dic['ExtAlarm4_23'] = json_obj['tags']['M-E_A_4-22'] #SPARE-2
                                                dic['ExtAlarm4_24'] = json_obj['tags']['M-E_A_4-23'] #SPARE-3
                                                dic['ExtAlarm4_25'] = json_obj['tags']['M-E_A_4-24'] #SCREW TEMPERATURE HIGH
                                                dic['ExtAlarm4_26'] = json_obj['tags']['M-E_A_4-25'] #SCREW TEMPERATURE LOW
                                                dic['ExtAlarm4_27'] = json_obj['tags']['M-E_A_4-26'] #EXTRUDER EMERGENCY PRESSED
                                                dic['ExtAlarm4_28'] = json_obj['tags']['M-E_A_4-27'] #INPUT CATTERPULLER EMERGENCY PRESSED
                                                dic['ExtAlarm4_29'] = json_obj['tags']['M-E_A_4-28'] #OUTPUT CATTERPULLER EMERGENCY PRESSED
                                                dic['ExtAlarm4_30'] = json_obj['tags']['M-E_A_4-29'] #TAKEUP1 EMERGENCY PRESSED
                                                dic['ExtAlarm4_31'] = json_obj['tags']['M-E_A_4-30'] #TAKEUP2 EMERGENCY PRESSED
                                                dic['ExtAlarm4_32'] = json_obj['tags']['M-E_A_4-31'] #TAKEUP1 END LIMIT ACTIVATED
                                                '''
                                                ...
                                                dic['VulAlarm1_32'] = fixedInt(json_obj['M-V_A_1-31']) #TAKEUP1 END LIMIT ACTIVATED
                                                ...
                                                dic['TestAlarm1_16'] = fixedInt(json_obj['M-T_A_1-15']) #SPARE 6
                                                ...
                                                dic['TestAlarm2_16'] = fixedInt(json_obj['M-T_A_2-15']) #SPARE 6
                                                ...
                                                '''
                                                dic['ExtPims2_1'] = json_obj['tags']['M-E_P_2-0'] #RED TAPE METER 1
                                                dic['ExtPims2_2'] = json_obj['tags']['M-E_P_2-1'] #RED TAPE METER 2
                                                dic['ExtPims2_3'] = json_obj['tags']['M-E_P_2-2'] #RED TAPE METER 3
                                                dic['ExtPims2_4'] = json_obj['tags']['M-E_P_2-3'] #RED TAPE METER 4
                                                dic['ExtPims2_5'] = json_obj['tags']['M-E_P_2-4'] #RED TAPE METER 5
                                                dic['ExtPims2_6'] = json_obj['tags']['M-E_P_2-5'] #RED TAPE METER 6
                                                dic['ExtPims2_7'] = json_obj['tags']['M-E_P_2-6'] #RED TAPE METER 7
                                                dic['ExtPims2_8'] = json_obj['tags']['M-E_P_2-7'] #RED TAPE METER 8
                                                dic['ExtPims2_9'] = json_obj['tags']['M-E_P_2-8'] #RED TAPE METER 9
                                                dic['ExtPims2_10'] = json_obj['tags']['M-E_P_2-9'] #RED TAPE METER 10
                                                dic['ExtPims2_11'] = json_obj['tags']['M-E_P_2-10'] #RED TAPE METER 11
                                                dic['ExtPims2_12'] = json_obj['tags']['M-E_P_2-11'] #RED TAPE METER 12
                                                dic['ExtPims2_13'] = json_obj['tags']['M-E_P_2-12'] #RED TAPE METER 13
                                                dic['ExtPims2_14'] = json_obj['tags']['M-E_P_2-13'] #RED TAPE METER 14
                                                dic['ExtPims2_15'] = json_obj['tags']['M-E_P_2-14'] #RED TAPE METER 15
                                                dic['ExtPims2_16'] = json_obj['tags']['M-E_P_2-15'] #RED TAPE METER 16
                                                dic['ExtPims2_17'] = json_obj['tags']['M-E_P_2-16'] #RED TAPE METER 15
                                                dic['ExtPims2_18'] = json_obj['tags']['M-E_P_2-17'] #RED TAPE METER 16
                                                dic['ExtPims2_19'] = json_obj['tags']['M-E_P_2-18'] #RED TAPE METER 17
                                                dic['ExtPims2_20'] = json_obj['tags']['M-E_P_2-19'] #RED TAPE METER 18
                                                dic['ExtPims2_21'] = json_obj['tags']['M-E_P_2-20'] #RED TAPE METER 19
                                                dic['ExtPims2_22'] = json_obj['tags']['M-E_P_2-21'] #RED TAPE METER 20
                                                dic['ExtPims2_23'] = json_obj['tags']['M-E_P_2-22'] #RED TAPE METER 21
                                                dic['ExtPims2_24'] = json_obj['tags']['M-E_P_2-23'] #RED TAPE METER 22
                                                dic['ExtPims2_25'] = json_obj['tags']['M-E_P_2-24'] #RED TAPE METER 23
                                                dic['ExtPims2_26'] = json_obj['tags']['M-E_P_2-25'] #RED TAPE METER 24
                                                dic['ExtPims2_27'] = json_obj['tags']['M-E_P_2-26'] #RED TAPE METER 25
                                                dic['ExtPims2_28'] = json_obj['tags']['M-E_P_2-27'] #RED TAPE METER 26
                                                dic['ExtPims2_29'] = json_obj['tags']['M-E_P_2-28'] #RED TAPE METER 27
                                                dic['ExtPims2_30'] = json_obj['tags']['M-E_P_2-29'] #RED TAPE METER 28
                                                dic['ExtPims2_31'] = json_obj['tags']['M-E_P_2-30'] #RED TAPE METER 29
                                                dic['ExtPims2_32'] = json_obj['tags']['M-E_P_2-31']#RED TAPE METER 30
                                                dic['ExtPims2_33'] = json_obj['tags']['M-E_P_2-32'] #RED TAPE METER 31
                                                dic['ExtPims2_34'] = json_obj['tags']['M-E_P_2-33'] #RED TAPE METER 32
                                                dic['ExtPims2_35'] = json_obj['tags']['M-E_P_2-34'] #RED TAPE METER 33
                                                dic['ExtPims2_36'] = json_obj['tags']['M-E_P_2-35'] #RED TAPE METER 34
                                                dic['ExtPims2_37'] = json_obj['tags']['M-E_P_2-36'] #RED TAPE METER 35
                                                dic['ExtPims2_38'] = json_obj['tags']['M-E_P_2-37'] #RED TAPE METER 36
                                                dic['ExtPims2_39'] = json_obj['tags']['M-E_P_2-38'] #RED TAPE METER 37
                                                dic['ExtPims2_40'] = json_obj['tags']['M-E_P_2-39'] #RED TAPE METER 38
                                                dic['ExtPims2_41'] = json_obj['tags']['M-E_P_2-40'] #RED TAPE METER 39
                                                dic['ExtPims2_42'] = json_obj['tags']['M-E_P_2-41'] #RED TAPE METER 40
                                                dic['ExtPims2_43'] = json_obj['tags']['M-E_P_2-42'] #RED TAPE METER 41
                                                dic['ExtPims2_44'] = json_obj['tags']['M-E_P_2-43'] #RED TAPE METER 42
                                                dic['ExtPims2_45'] = json_obj['tags']['M-E_P_2-44'] #RED TAPE METER 43
                                                dic['ExtPims2_46'] = json_obj['tags']['M-E_P_2-45'] #RED TAPE METER 44
                                                dic['ExtPims2_47'] = json_obj['tags']['M-E_P_2-46'] #RED TAPE METER 45
                                                dic['ExtPims2_48'] = json_obj['tags']['M-E_P_2-47'] #RED TAPE METER 46
                                                dic['ExtPims2_49'] = json_obj['tags']['M-E_P_2-48'] #RED TAPE METER 47
                                                dic['ExtPims2_50'] = json_obj['tags']['M-E_P_2-49'] #RED TAPE METER 48
                                                dic['ExtPims2_51'] = json_obj['tags']['M-E_P_2-50'] #RED TAPE METER 49
                                                dic['ExtPims2_52'] = json_obj['tags']['M-E_P_2-51'] #RED TAPE METER 50
                                                dic['ExtPims2_53'] = json_obj['tags']['M-E_P_2-52'] #RED TAPE METER 51
                                                dic['ExtPims2_54'] = json_obj['tags']['M-E_P_2-53'] #RED TAPE METER 52
                                                dic['ExtPims2_55'] = json_obj['tags']['M-E_P_2-54'] #RED TAPE METER 53
                                                dic['ExtPims2_56'] = json_obj['tags']['M-E_P_2-55'] #RED TAPE METER 54
                                                dic['ExtPims2_57'] = json_obj['tags']['M-E_P_2-56'] #RED TAPE METER 55
                                                dic['ExtPims2_58'] = json_obj['tags']['M-E_P_2-57'] #RED TAPE METER 56
                                                dic['ExtPims2_59'] = json_obj['tags']['M-E_P_2-58'] #RED TAPE METER 57
                                                dic['ExtPims2_60'] = json_obj['tags']['M-E_P_2-59'] #RED TAPE METER 58
                                                dic['ExtPims2_61'] = json_obj['tags']['M-E_P_2-60'] #RED TAPE METER 59
                                                dic['ExtPims2_62'] = json_obj['tags']['M-E_P_2-61'] #RED TAPE METER 60
                                                dic['ExtPims2_63'] = json_obj['tags']['M-E_P_2-62'] #RED TAPE METER 61
                                                dic['ExtPims2_64'] = json_obj['tags']['M-E_P_2-63'] #RED TAPE METER 62
                                                dic['ExtPims2_65'] = json_obj['tags']['M-E_P_2-64'] #RED TAPE METER 63
                                                dic['ExtPims2_66'] = json_obj['tags']['M-E_P_2-65'] #RED TAPE METER 64
                                                dic['ExtPims2_67'] = json_obj['tags']['M-E_P_2-66'] #RED TAPE METER 65
                                                dic['ExtPims2_68'] = json_obj['tags']['M-E_P_2-67']#RED TAPE METER 66
                                                dic['ExtPims2_69'] = json_obj['tags']['M-E_P_2-68'] #RED TAPE METER 67
                                                dic['ExtPims2_70'] = json_obj['tags']['M-E_P_2-69'] #RED TAPE METER 68
                                                dic['ExtPims2_71'] = json_obj['tags']['M-E_P_2-70'] #RED TAPE METER 69
                                                dic['ExtPims2_72'] = json_obj['tags']['M-E_P_2-71'] #RED TAPE METER 70
                                                dic['ExtPims2_73'] = json_obj['tags']['M-E_P_2-72'] #RED TAPE METER 71
                                                dic['ExtPims2_74'] = json_obj['tags']['M-E_P_2-73'] #RED TAPE METER 72
                                                dic['ExtPims2_75'] = json_obj['tags']['M-E_P_2-74'] #RED TAPE METER 73
                                                dic['ExtPims2_76'] = json_obj['tags']['M-E_P_2-75'] #RED TAPE METER 74
                                                dic['ExtPims2_77'] = json_obj['tags']['M-E_P_2-76'] #RED TAPE METER 75
                                                dic['ExtPims2_78'] = json_obj['tags']['M-E_P_2-77'] #RED TAPE METER 76
                                                dic['ExtPims2_79'] = json_obj['tags']['M-E_P_2-78'] #RED TAPE METER 77
                                                dic['ExtPims2_80'] = json_obj['tags']['M-E_P_2-79'] #RED TAPE METER 78
                                                dic['ExtPims2_81'] = json_obj['tags']['M-E_P_2-80'] #DRUM IN
                                                dic['ExtPims2_82'] = json_obj['tags']['M-E_P_2-81'] #DRUM OUT
                                                '''
                                                ...
                                                '''
                                                dic['ExtPims4_1'] = json_obj['tags']['M-E_P_4-0'] #RED TAPE METER 1
                                                dic['ExtPims4_2'] = json_obj['tags']['M-E_P_4-1'] #RED TAPE METER 2
                                                dic['ExtPims4_3'] = json_obj['tags']['M-E_P_4-2'] #RED TAPE METER 3
                                                dic['ExtPims4_4'] = json_obj['tags']['M-E_P_4-3'] #RED TAPE METER 4
                                                dic['ExtPims4_5'] = json_obj['tags']['M-E_P_4-4'] #RED TAPE METER 5
                                                dic['ExtPims4_6'] = json_obj['tags']['M-E_P_4-5'] #RED TAPE METER 6
                                                dic['ExtPims4_7'] = json_obj['tags']['M-E_P_4-6'] #RED TAPE METER 7
                                                dic['ExtPims4_8'] = json_obj['tags']['M-E_P_4-7'] #RED TAPE METER 8
                                                dic['ExtPims4_9'] = json_obj['tags']['M-E_P_4-8'] #RED TAPE METER 9
                                                dic['ExtPims4_10'] = json_obj['tags']['M-E_P_4-9'] #RED TAPE METER 10
                                                dic['ExtPims4_11'] = json_obj['tags']['M-E_P_4-10'] #RED TAPE METER 11
                                                dic['ExtPims4_12'] = json_obj['tags']['M-E_P_4-11'] #RED TAPE METER 12
                                                dic['ExtPims4_13'] = json_obj['tags']['M-E_P_4-12'] #RED TAPE METER 13
                                                dic['ExtPims4_14'] = json_obj['tags']['M-E_P_4-13'] #RED TAPE METER 14
                                                dic['ExtPims4_15'] = json_obj['tags']['M-E_P_4-14'] #RED TAPE METER 15
                                                dic['ExtPims4_16'] = json_obj['tags']['M-E_P_4-15'] #RED TAPE METER 16
                                                dic['ExtPims4_17'] = json_obj['tags']['M-E_P_4-16'] #RED TAPE METER 15
                                                dic['ExtPims4_18'] = json_obj['tags']['M-E_P_4-17'] #RED TAPE METER 16
                                                dic['ExtPims4_19'] = json_obj['tags']['M-E_P_4-18'] #RED TAPE METER 17
                                                dic['ExtPims4_20'] = json_obj['tags']['M-E_P_4-19'] #RED TAPE METER 18
                                                dic['ExtPims4_21'] = json_obj['tags']['M-E_P_4-20'] #RED TAPE METER 19
                                                dic['ExtPims4_22'] = json_obj['tags']['M-E_P_4-21'] #RED TAPE METER 20
                                                dic['ExtPims4_23'] = json_obj['tags']['M-E_P_4-22'] #RED TAPE METER 21
                                                dic['ExtPims4_24'] = json_obj['tags']['M-E_P_4-23'] #RED TAPE METER 22
                                                dic['ExtPims4_25'] = json_obj['tags']['M-E_P_4-24'] #RED TAPE METER 23
                                                dic['ExtPims4_26'] = json_obj['tags']['M-E_P_4-25'] #RED TAPE METER 24
                                                dic['ExtPims4_27'] = json_obj['tags']['M-E_P_4-26'] #RED TAPE METER 25
                                                dic['ExtPims4_28'] = json_obj['tags']['M-E_P_4-27'] #RED TAPE METER 26
                                                dic['ExtPims4_29'] = json_obj['tags']['M-E_P_4-28'] #RED TAPE METER 27
                                                dic['ExtPims4_30'] = json_obj['tags']['M-E_P_4-29'] #RED TAPE METER 28
                                                dic['ExtPims4_31'] = json_obj['tags']['M-E_P_4-30'] #RED TAPE METER 29
                                                dic['ExtPims4_32'] = json_obj['tags']['M-E_P_4-31']#RED TAPE METER 30
                                                dic['ExtPims4_33'] = json_obj['tags']['M-E_P_4-32'] #RED TAPE METER 31
                                                dic['ExtPims4_34'] = json_obj['tags']['M-E_P_4-33'] #RED TAPE METER 32
                                                dic['ExtPims4_35'] = json_obj['tags']['M-E_P_4-34'] #RED TAPE METER 33
                                                dic['ExtPims4_36'] = json_obj['tags']['M-E_P_4-35'] #RED TAPE METER 34
                                                dic['ExtPims4_37'] = json_obj['tags']['M-E_P_4-36'] #RED TAPE METER 35
                                                dic['ExtPims4_38'] = json_obj['tags']['M-E_P_4-37'] #RED TAPE METER 36
                                                dic['ExtPims4_39'] = json_obj['tags']['M-E_P_4-38'] #RED TAPE METER 37
                                                dic['ExtPims4_40'] = json_obj['tags']['M-E_P_4-39'] #RED TAPE METER 38
                                                dic['ExtPims4_41'] = json_obj['tags']['M-E_P_4-40'] #RED TAPE METER 39
                                                dic['ExtPims4_42'] = json_obj['tags']['M-E_P_4-41'] #RED TAPE METER 40
                                                dic['ExtPims4_43'] = json_obj['tags']['M-E_P_4-42'] #RED TAPE METER 41
                                                dic['ExtPims4_44'] = json_obj['tags']['M-E_P_4-43'] #RED TAPE METER 42
                                                dic['ExtPims4_45'] = json_obj['tags']['M-E_P_4-44'] #RED TAPE METER 43
                                                dic['ExtPims4_46'] = json_obj['tags']['M-E_P_4-45'] #RED TAPE METER 44
                                                dic['ExtPims4_47'] = json_obj['tags']['M-E_P_4-46'] #RED TAPE METER 45
                                                dic['ExtPims4_48'] = json_obj['tags']['M-E_P_4-47'] #RED TAPE METER 46
                                                dic['ExtPims4_49'] = json_obj['tags']['M-E_P_4-48'] #RED TAPE METER 47
                                                dic['ExtPims4_50'] = json_obj['tags']['M-E_P_4-49'] #RED TAPE METER 48
                                                dic['ExtPims4_51'] = json_obj['tags']['M-E_P_4-50'] #RED TAPE METER 49
                                                dic['ExtPims4_52'] = json_obj['tags']['M-E_P_4-51'] #RED TAPE METER 50
                                                dic['ExtPims4_53'] = json_obj['tags']['M-E_P_4-52'] #RED TAPE METER 51
                                                dic['ExtPims4_54'] = json_obj['tags']['M-E_P_4-53'] #RED TAPE METER 52
                                                dic['ExtPims4_55'] = json_obj['tags']['M-E_P_4-54'] #RED TAPE METER 53
                                                dic['ExtPims4_56'] = json_obj['tags']['M-E_P_4-55'] #RED TAPE METER 54
                                                dic['ExtPims4_57'] = json_obj['tags']['M-E_P_4-56'] #RED TAPE METER 55
                                                dic['ExtPims4_58'] = json_obj['tags']['M-E_P_4-57'] #RED TAPE METER 56
                                                dic['ExtPims4_59'] = json_obj['tags']['M-E_P_4-58'] #RED TAPE METER 57
                                                dic['ExtPims4_60'] = json_obj['tags']['M-E_P_4-59'] #RED TAPE METER 58
                                                dic['ExtPims4_61'] = json_obj['tags']['M-E_P_4-60'] #RED TAPE METER 59
                                                dic['ExtPims4_62'] = json_obj['tags']['M-E_P_4-61'] #RED TAPE METER 60
                                                dic['ExtPims4_63'] = json_obj['tags']['M-E_P_4-62'] #RED TAPE METER 61
                                                dic['ExtPims4_64'] = json_obj['tags']['M-E_P_4-63'] #RED TAPE METER 62
                                                dic['ExtPims4_65'] = json_obj['tags']['M-E_P_4-64'] #RED TAPE METER 63
                                                dic['ExtPims4_66'] = json_obj['tags']['M-E_P_4-65'] #RED TAPE METER 64
                                                dic['ExtPims4_67'] = json_obj['tags']['M-E_P_4-66'] #RED TAPE METER 65
                                                dic['ExtPims4_68'] = json_obj['tags']['M-E_P_4-67']#RED TAPE METER 66
                                                dic['ExtPims4_69'] = json_obj['tags']['M-E_P_4-68'] #RED TAPE METER 67
                                                dic['ExtPims4_70'] = json_obj['tags']['M-E_P_4-69'] #RED TAPE METER 68
                                                dic['ExtPims4_71'] = json_obj['tags']['M-E_P_4-70'] #RED TAPE METER 69
                                                dic['ExtPims4_72'] = json_obj['tags']['M-E_P_4-71'] #RED TAPE METER 70
                                                dic['ExtPims4_73'] = json_obj['tags']['M-E_P_4-72'] #RED TAPE METER 71
                                                dic['ExtPims4_74'] = json_obj['tags']['M-E_P_4-73'] #RED TAPE METER 72
                                                dic['ExtPims4_75'] = json_obj['tags']['M-E_P_4-74'] #RED TAPE METER 73
                                                dic['ExtPims4_76'] = json_obj['tags']['M-E_P_4-75'] #RED TAPE METER 74
                                                dic['ExtPims4_77'] = json_obj['tags']['M-E_P_4-76'] #RED TAPE METER 75
                                                dic['ExtPims4_78'] = json_obj['tags']['M-E_P_4-77'] #RED TAPE METER 76
                                                dic['ExtPims4_79'] = json_obj['tags']['M-E_P_4-78'] #RED TAPE METER 77
                                                dic['ExtPims4_80'] = json_obj['tags']['M-E_P_4-79'] #RED TAPE METER 78
                                                dic['ExtPims4_81'] = json_obj['tags']['M-E_P_4-80'] #DRUM IN
                                                dic['ExtPims4_82'] = json_obj['tags']['M-E_P_4-81'] #DRUM OUT
                                                '''
                                                ...
                                                dic['ExtStopMessage1'] = ""
                                                '''
                                                dic['ExtStop2_1'] = json_obj['tags']['M-E_S_2-0'] #Int value containing 1-20 value's
                                                dic['ExtStop2_2'] = json_obj['tags']['M-E_S_2-1'] #Boolean value containing on off status
                                                dic['ExtStopMessage2'] = ""
                                                '''
                                                ...
                                                dic['ExtStopMessage3'] = ""
                                                '''
                                                dic['ExtStop4_1'] = json_obj['tags']['M-E_S_4-0'] #Int value containing 1-20 value's
                                                dic['ExtStop4_2'] = json_obj['tags']['M-E_S_4-1'] #Boolean value containing on off status
                                                dic['ExtStopMessage4'] = ""
                                                '''
                                                ...
                                                dic['ManStopMessage2'] = ""
                                                '''
                                                dic['ManStop3_1'] = json_obj['tags']['M-M_S_3-0'] #Int value containing 1-20 value's
                                                dic['ManStop3_2'] = json_obj['tags']['M-M_S_3-1'] #Boolean value containing on off status
                                                dic['ManStopMessage3'] = ""
                                                '''
                                                ...
                                                dic['ExtProd1_1'] = dic['Extruder1_1'] #PIR
                                                dic['ExtProd1_2'] = dic['Extruder1_2'] #Operator Name
                                                ...
                                                dic['ExtProd1_10'] = dic['ExtPims1_1'] #Drum In # coming from ext tag
                                                dic['ExtProd1_11'] = dic['ExtPims1_2'] #Drum Out #coming from ext tag
                                                dic['ExtProd1_12'] = fixedInt(json_obj['M-E_H_1-48']) #Middle temp
                                                dic['ExtProd1_13'] = fixedInt(json_obj['M-E_H_1-50']) #Machine run fb

                                                dic['ExtProd3_1'] = dic['Extruder3_1'] #PIR
                                                dic['ExtProd3_2'] = dic['Extruder3_2'] #Operator Name
                                                ...
                                                dic['ExtProd3_10'] = dic['ExtPims3_1'] #Drum In # coming from ext tag
                                                dic['ExtProd3_11'] = dic['ExtPims3_2'] #Drum Out #coming from ext tag
                                                dic['ExtProd3_12'] = fixedInt(json_obj['M-E_H_3-48']) #Middle temp
                                                dic['ExtProd3_13'] = fixedInt(json_obj['M-E_H_3-50']) #Machine run fb



                                                dic['VulProd1_1'] = dic['Vulcanizer1_1'] #PIR
                                                dic['VulProd1_2'] = dic['Vulcanizer1_2'] #Operator Name
                                                ...
                                                dic['VulProd1_9'] = dic['VulPims1_1'] #Drum No. # coming from vul tag
                                                dic['VulProd1_10'] = fixedInt(json_obj['M-V_H_1-2']) # Machine Run FB


                                                dic['ManProd1_1'] = dic['Mandrel1_1'] #PIR
                                                dic['ManProd1_2'] = dic['Mandrel1_2'] #Operator Name
                                                ...
                                                dic['ManProd1_7'] = dic['ManPims1_1'] #Drum No.
                                                dic['ManProd1_8'] = fixedInt(json_obj['M-M_H_1-4']) #Process Start Bit
                                                dic['ManProd1_9'] = fixedInt(json_obj['M-M_H_1-7']) #Qty

                                                dic['ManProd2_1'] = dic['Mandrel2_1'] #PIR
                                                dic['ManProd2_2'] = dic['Mandrel2_2'] #Operator Name
                                                ...
                                                dic['ManProd2_7'] = dic['ManPims1_1'] #Drum No.
                                                dic['ManProd2_8'] = fixedInt(json_obj['M-M_H_1-4']) #Process Start Bit
                                                dic['ManProd2_9'] = fixedInt(json_obj['M-M_H_2-7']) #Qty


                                                dic['TestProd1_1'] = dic['Testing1_1'] #PIR
                                                dic['TestProd1_2'] = dic['Testing1_2'] #Operator Name
                                                dic['TestProd1_3'] = fixedInt(json_obj['M-T_R_1-5']) #Proof Pres
                                                dic['TestProd1_4'] = fixedInt(json_obj['M-T_H_1-2']) #Scrap Len
                                                dic['TestProd1_5'] = dic['TestPims1_1'] #Drum In
                                                dic['TestProd1_6'] = dic['TestPims1_2'] #Drum Out
                                                dic['TestProd1_8'] = fixedInt(json_obj['M-T_H_1-0']) #Process Start Bit
                                                dic['TestProd1_9'] = fixedInt(json_obj['M-T_H_1-4']) #Process Start Bit

                                                dic['TestProd2_1'] = dic['Testing2_1'] #PIR
                                                dic['TestProd2_2'] = dic['Testing2_2'] #Operator Name
                                                dic['TestProd2_3'] = fixedInt(json_obj['M-T_R_2-5']) #Proof Pres
                                                dic['TestProd2_4'] = fixedInt(json_obj['M-T_H_2-2']) #Scrap Len
                                                dic['TestProd2_5'] = dic['TestPims2_1'] #Drum In
                                                dic['TestProd2_6'] = dic['TestPims2_2'] #Drum Out
                                                dic['TestProd2_8'] = fixedInt(json_obj['M-T_H_2-0']) #Process Start Bit
                                                dic['TestProd2_9'] = fixedInt(json_obj['M-T_H_2-4']) #Process Start Bit


                                                dic['TestProd3_1'] = dic['Testing3_1'] #PIR
                                                dic['TestProd3_2'] = dic['Testing3_2'] #Operator Name
                                                dic['TestProd3_3'] = fixedInt(json_obj['M-T_R_3-5']) #Proof Pres
                                                dic['TestProd3_4'] = fixedInt(json_obj['M-T_H_3-2']) #Scrap Len
                                                dic['TestProd3_5'] = dic['TestPims3_1'] #Drum In
                                                dic['TestProd3_6'] = dic['TestPims3_2'] #Drum Out
                                                dic['TestProd3_8'] = fixedInt(json_obj['M-T_H_3-0']) #Process Start Bit
                                                dic['TestProd3_9'] = fixedInt(json_obj['M-T_H_3-4']) #Process Start Bit
...
def sql2():
    try:
        ...
        mydb.commit()
        '''
        sql = "INSERT INTO mandrelreport3 ( pir , operator_name , program_name , mandrel_id , actual_od , minimum_od , maximum_od, fixed_block_st, movable_block_st, fixed_block_at, movable_block_at) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = ( str(dic['Mandrel3_1']), str(dic['Mandrel3_2']),
                str(dic['Mandrel3_3']), findFloat(float(dic['Mandrel3_4'])),
                findFloat(float(dic['Mandrel3_5'])), findFloat(float(dic['Mandrel3_6'])), 
                findFloat(float(dic['Mandrel3_7'])), findFloat(float(dic['Mandrel3_8'])), 
                findFloat(float(dic['Mandrel3_9'])), findFloat(float(dic['Mandrel3_10'])), 
                findFloat(float(dic['Mandrel3_11'])))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        
        sql = "INSERT INTO extruderreport1 ( pir , operator_name , line_run_feedback , od_setpoint , od_actual , id_setpoint , id_actual, thickness_set, thickness_act, ext_rpm_set, ext_rpm_act, ext_cur_set, ext_cur_act, ext_pre_set, ext_pre_act, line_mpm_set, line_mpm_act, prod_meter, head_temp_sp, head_temp_act, screw_temp_sp, screw_temp_act, zone2_temp_sp, zone2_temp_act, zone3_temp_sp, zone3_temp_act) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        mydb.commit()
        '''
        sql = "INSERT INTO extruderreport2 ( pir , operator_name , line_run_feedback , od_setpoint , od_actual , id_setpoint , id_actual, thickness_set, thickness_act, ext_rpm_set, ext_rpm_act, ext_cur_set, ext_cur_act, ext_pre_set, ext_pre_act, line_mpm_set, line_mpm_act, prod_meter, head_temp_sp, head_temp_act, screw_temp_sp, screw_temp_act, zone2_temp_sp, zone2_temp_act, zone3_temp_sp, zone3_temp_act) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = ( str(dic['Extruder2_1']), str(dic['Extruder2_2']),
                findBool(dic['Extruder2_3']), findFloat(float(dic['Extruder2_4'])),
                findFloat(float(dic['Extruder2_5'])), findFloat(float(dic['Extruder2_6'])), 
                findFloat(float(dic['Extruder2_7'])), findFloat(float(dic['Extruder2_8'])), 
                findFloat(float(dic['Extruder2_9'])), findFloat(float(dic['Extruder2_10'])), 
                findFloat(float(dic['Extruder2_11'])),findFloat(float(dic['Extruder2_12'])),
                findFloat(float(dic['Extruder2_13'])),findFloat(float(dic['Extruder2_14'])),
                findFloat(float(dic['Extruder2_15'])),findFloat(float(dic['Extruder2_16'])),
                findFloat(float(dic['Extruder2_17'])),findFloat(float(dic['Extruder2_18'])),
                findFloat(float(dic['Extruder2_19'])),findFloat(float(dic['Extruder2_20'])),
                findFloat(float(dic['Extruder2_21'])),findFloat(float(dic['Extruder2_22'])),
                findFloat(float(dic['Extruder2_23'])),findFloat(float(dic['Extruder2_24'])),
                findFloat(float(dic['Extruder2_25'])),findFloat(float(dic['Extruder2_26'])))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        ...
        mydb.commit()
        '''
        sql = "INSERT INTO extruderreport4 ( pir , operator_name , line_run_feedback , od_setpoint , od_actual , id_setpoint , id_actual, thickness_set, thickness_act, ext_rpm_set, ext_rpm_act, ext_cur_set, ext_cur_act, ext_pre_set, ext_pre_act, line_mpm_set, line_mpm_act, prod_meter, head_temp_sp, head_temp_act, screw_temp_sp, screw_temp_act, zone2_temp_sp, zone2_temp_act, zone3_temp_sp, zone3_temp_act) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = ( str(dic['Extruder4_1']), str(dic['Extruder4_2']),
                findBool(dic['Extruder4_3']), findFloat(float(dic['Extruder4_4'])),
                findFloat(float(dic['Extruder4_5'])), findFloat(float(dic['Extruder4_6'])), 
                findFloat(float(dic['Extruder4_7'])), findFloat(float(dic['Extruder4_8'])), 
                findFloat(float(dic['Extruder4_9'])), findFloat(float(dic['Extruder4_10'])), 
                findFloat(float(dic['Extruder4_11'])),findFloat(float(dic['Extruder4_12'])),
                findFloat(float(dic['Extruder4_13'])),findFloat(float(dic['Extruder4_14'])),
                findFloat(float(dic['Extruder4_15'])),findFloat(float(dic['Extruder4_16'])),
                findFloat(float(dic['Extruder4_17'])),findFloat(float(dic['Extruder4_18'])),
                findFloat(float(dic['Extruder4_19'])),findFloat(float(dic['Extruder4_20'])),
                findFloat(float(dic['Extruder4_21'])),findFloat(float(dic['Extruder4_22'])),
                findFloat(float(dic['Extruder4_23'])),findFloat(float(dic['Extruder4_24'])),
                findFloat(float(dic['Extruder4_25'])),findFloat(float(dic['Extruder4_26'])))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        ...
        if(globalBS.tempExtProd1 != findBool(dic['ExtProd1_8'])):
                ...
                if(findBool(dic['ExtProd1_8']) == False):
                        ...
                        sql = "INSERT INTO extproduction1 ( ontime, pir, operator_name, mpir, act_kg, actual_speed, prod_time, ex_hd_pr, start_temp, middle_temp, last_temp, drum_in, drum_out ) VALUES (%s, %s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                        val = (globalBS.tempExtDT1, str(dic['ExtProd1_1']), str(dic['ExtProd1_2']), str(dic['ExtProd1_3']), findFloat(float(dic['ExtProd1_4'])), findFloat(float(dic['ExtProd1_5'])), int(globalBS.tempExtElapsed1) , findFloat(float(dic['ExtProd1_6'])), findFloat(float(dic['ExtProd1_7'])), findFloat(float(dic['ExtProd1_12'])), findFloat(float(dic['ExtProd1_9'])), int(dic['ExtProd1_10']), int(dic['ExtProd1_11']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempExtProd3 != findBool(dic['ExtProd3_8'])):
                ...
                if(findBool(dic['ExtProd3_8']) == False):
                        ...
                        sql = "INSERT INTO extproduction3 ( ontime, pir, operator_name, mpir, act_kg, actual_speed, prod_time, ex_hd_pr, start_temp, middle_temp, last_temp, drum_in, drum_out ) VALUES (%s, %s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                        val = (globalBS.tempExtDT3, str(dic['ExtProd3_1']), str(dic['ExtProd3_2']), str(dic['ExtProd3_3']), findFloat(float(dic['ExtProd3_4'])), findFloat(float(dic['ExtProd3_5'])), int(globalBS.tempExtElapsed3) , findFloat(float(dic['ExtProd3_6'])), findFloat(float(dic['ExtProd3_7'])), findFloat(float(dic['ExtProd3_12'])), findFloat(float(dic['ExtProd3_9'])), int(dic['ExtProd3_10']), int(dic['ExtProd3_11']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempVulProd1 != findBool(dic['VulProd1_8'])):
                ...
                if(findBool(dic['VulProd1_8']) == False):
                        ...
                        sql = "INSERT INTO vulproduction1 ( ontime, pir_1, pir_2, pir_3, pir_4, pir_5, pir_6, operator_name, drum_no, total_vul_time ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                        val = (globalBS.tempVulDT1, str(dic['VulProd1_1']), str(dic['VulProd1_3']), str(dic['VulProd1_4']), str(dic['VulProd1_5']), str(dic['VulProd1_6']), str(dic['VulProd1_7']), str(dic['VulProd1_2']), int(dic['VulProd1_9']), int(globalBS.tempVulElapsed1))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempManProd1 != findBool(dic['ManProd1_8'])):
                ...
                if(findBool(dic['ManProd1_8']) == False):
                        ...
                        val = (globalBS.tempManDT1, str(dic['ManProd1_1']), str(dic['ManProd1_2']), str(dic['ManProd1_3']), str(dic['ManProd1_4']), str(dic['ManProd1_5']), str(dic['ManProd1_6']), int(dic['ManProd1_9']), int(dic['ManProd1_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempManProd2 != findBool(dic['ManProd2_8'])):
                ...
                if(findBool(dic['ManProd2_8']) == False):
                        ...
                        val = (globalBS.tempManDT2, str(dic['ManProd2_1']), str(dic['ManProd2_2']), str(dic['ManProd2_3']), str(dic['ManProd2_4']), str(dic['ManProd2_5']), str(dic['ManProd2_6']), int(dic['ManProd2_9']), int(dic['ManProd2_7']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempTestProd1 != findBool(dic['TestProd1_8'])):
                ...
                if(findBool(dic['TestProd1_8']) == False):
                        ...
                        sql = "INSERT INTO testproduction1 ( ontime, pir, operator_name, proof_pres, scrap_len, total_time, drum_in, drum_out) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
                        val = (globalBS.tempTestDT1, str(dic['TestProd1_1']), str(dic['TestProd1_2']), str(dic['TestProd1_3']), str(dic['TestProd1_4']), int(globalBS.tempTestElapsed1), int(dic['TestProd1_5']), int(dic['TestProd1_6']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempTestProd2 != findBool(dic['TestProd2_8'])):
                ...
                if(findBool(dic['TestProd2_8']) == False):
                        ...
                        sql = "INSERT INTO testproduction2 ( ontime, pir, operator_name, proof_pres, scrap_len, total_time, drum_in, drum_out) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
                        val = (globalBS.tempTestDT2, str(dic['TestProd2_1']), str(dic['TestProd2_2']), str(dic['TestProd2_3']), str(dic['TestProd2_4']), int(globalBS.tempTestElapsed2), int(dic['TestProd2_5']), int(dic['TestProd2_6']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        if(globalBS.tempTestProd3 != findBool(dic['TestProd3_8'])):
                ...
                if(findBool(dic['TestProd3_8']) == False):
                        ...
                        sql = "INSERT INTO testproduction3 ( ontime, pir, operator_name, proof_pres, scrap_len, total_time, drum_in, drum_out) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
                        val = (globalBS.tempTestDT3, str(dic['TestProd3_1']), str(dic['TestProd3_2']), str(dic['TestProd3_3']), str(dic['TestProd3_4']), int(globalBS.tempTestElapsed3), int(dic['TestProd3_5']), int(dic['TestProd3_6']))
                        mycursor.execute(sql, val)
                        mydb.commit()
        ...
        '''
        if(tempMan3_1 != findBool(dic['ManAlarm3_1'])):
                tempMan3_1 = findBool(dic['ManAlarm3_1'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (1, 'TCI-1 PUMP MPCB TRIPPED', findBool(dic['ManAlarm3_1']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_2 != findBool(dic['ManAlarm3_2'])):
                tempMan3_2 = findBool(dic['ManAlarm3_2'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (2, 'TCI-1 AGITATOR MPCB TRIPPED', findBool(dic['ManAlarm3_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_3 != findBool(dic['ManAlarm3_3'])):
                tempMan3_3 = findBool(dic['ManAlarm3_3'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (3, 'TCI-2 PUMP MPCB TRIPPED', findBool(dic['ManAlarm3_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_4 != findBool(dic['ManAlarm3_4'])):
                tempMan3_4 = findBool(dic['ManAlarm3_4'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (4, 'TCI=2 AGITATOR MPCB TRIPPED', findBool(dic['ManAlarm3_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_5 != findBool(dic['ManAlarm3_5'])):
                tempMan3_5 = findBool(dic['ManAlarm3_5'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (5, 'TAKEUP DRIVE FAULT', findBool(dic['ManAlarm3_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_6 != findBool(dic['ManAlarm3_6'])):
                tempMan3_6 = findBool(dic['ManAlarm3_6'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (6, 'TAKEUP DRIVE ALARM', findBool(dic['ManAlarm3_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_7 != findBool(dic['ManAlarm3_7'])):
                tempMan3_7 = findBool(dic['ManAlarm3_7'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (7, 'MANDREL OD HIGH LINE STOPPED', findBool(dic['ManAlarm3_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_8 != findBool(dic['ManAlarm3_8'])):
                tempMan3_8 = findBool(dic['ManAlarm3_8'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (8, 'MANDREL OD LOW LINE STOPPED', findBool(dic['ManAlarm3_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_9 != findBool(dic['ManAlarm3_9'])):
                tempMan3_9 = findBool(dic['ManAlarm3_9'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (9, 'PANEL EMERGENCY PRESSED', findBool(dic['ManAlarm3_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_10 != findBool(dic['ManAlarm3_10'])):
                tempMan3_10 = findBool(dic['ManAlarm3_10'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (10, 'TAKEUP EMERGENCY PRESSED', findBool(dic['ManAlarm3_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_11 != findBool(dic['ManAlarm3_11'])):
                tempMan3_11 = findBool(dic['ManAlarm3_11'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (11, 'SPARE 1', findBool(dic['ManAlarm3_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_12 != findBool(dic['ManAlarm3_12'])):
                tempMan3_12 = findBool(dic['ManAlarm3_12'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (12, 'SPARE 2', findBool(dic['ManAlarm3_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_13 != findBool(dic['ManAlarm3_13'])):
                tempMan3_13 = findBool(dic['ManAlarm3_13'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (13, 'SPARE 3', findBool(dic['ManAlarm3_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_14 != findBool(dic['ManAlarm3_14'])):
                tempMan3_14 = findBool(dic['ManAlarm2_14'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (14, 'SPARE 4', findBool(dic['ManAlarm3_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_15 != findBool(dic['ManAlarm3_15'])):
                tempMan3_15 = findBool(dic['ManAlarm3_15'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (15, 'SPARE 5', findBool(dic['ManAlarm3_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_16 != findBool(dic['ManAlarm3_16'])):
                tempMan3_16 = findBool(dic['ManAlarm3_16'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (16, 'SPARE 6', findBool(dic['ManAlarm3_16']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_17 != findBool(dic['ManAlarm3_17'])):
                tempMan3_17 = findBool(dic['ManAlarm3_17'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (17, 'MANDREL OD HIGH', findBool(dic['ManAlarm3_17']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempMan3_18 != findBool(dic['ManAlarm3_18'])):
                tempMan3_18 = findBool(dic['ManAlarm3_18'])
                sql = "INSERT INTO manalarm3 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (18, 'MANDREL OD LOW', findBool(dic['ManAlarm3_18']))
                mycursor.execute(sql, val)
                mydb.commit()
                '''
        ...
        '''
        if(tempExt2_1 != findBool(dic['ExtAlarm2_1'])):
                tempExt2_1 = findBool(dic['ExtAlarm2_1'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (1, 'THICKNESS  HIGH', findBool(dic['ExtAlarm2_1']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_2 != findBool(dic['ExtAlarm2_2'])):
                tempExt2_2 = findBool(dic['ExtAlarm2_2'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (2, 'THICKNESS LOW', findBool(dic['ExtAlarm2_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_3 != findBool(dic['ExtAlarm2_3'])):
                tempExt2_3 = findBool(dic['ExtAlarm2_3'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (3, 'HEAD TEMPERATURE HIGH', findBool(dic['ExtAlarm2_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_4 != findBool(dic['ExtAlarm2_4'])):
                tempExt2_4 = findBool(dic['ExtAlarm2_4'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (4, 'HEAD TEMPERATURE LOW', findBool(dic['ExtAlarm2_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_5 != findBool(dic['ExtAlarm2_5'])):
                tempExt2_5 = findBool(dic['ExtAlarm2_5'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (5, 'ZONE 2 TEMPERATURE HIGH', findBool(dic['ExtAlarm2_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_6 != findBool(dic['ExtAlarm2_6'])):
                tempExt2_6 = findBool(dic['ExtAlarm2_6'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (6, 'ZONE 2 TEMPERATURE LOW', findBool(dic['ExtAlarm2_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_7 != findBool(dic['ExtAlarm2_7'])):
                tempExt2_7 = findBool(dic['ExtAlarm2_7'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (7, 'ZONE 3 TEMPERATURE HIGH', findBool(dic['ExtAlarm2_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_8 != findBool(dic['ExtAlarm2_8'])):
                tempExt2_8 = findBool(dic['ExtAlarm2_8'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (8, 'ZONE 3 TEMPERATURE LOW', findBool(dic['ExtAlarm2_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_9 != findBool(dic['ExtAlarm2_9'])):
                tempExt2_9 = findBool(dic['ExtAlarm2_9'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (9, 'EXTRUDER CURRENT WARNING HIGH', findBool(dic['ExtAlarm2_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_10 != findBool(dic['ExtAlarm2_10'])):
                tempExt2_10 = findBool(dic['ExtAlarm2_10'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (10, 'EXTRUDER CURRENT ALARM HIGH', findBool(dic['ExtAlarm2_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_11 != findBool(dic['ExtAlarm2_11'])):
                tempExt2_11 = findBool(dic['ExtAlarm2_11'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (11, 'EXTRUDER PRESSURE WANING HIGH', findBool(dic['ExtAlarm2_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_12 != findBool(dic['ExtAlarm2_12'])):
                tempExt2_12 = findBool(dic['ExtAlarm2_12'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (12, 'EXTRUDER PRESSURE ALARM HIGH', findBool(dic['ExtAlarm2_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_13 != findBool(dic['ExtAlarm2_13'])):
                tempExt2_13 = findBool(dic['ExtAlarm2_13'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (13, 'OUTER DIAMETER HIGH', findBool(dic['ExtAlarm2_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_14 != findBool(dic['ExtAlarm2_14'])):
                tempExt2_14 = findBool(dic['ExtAlarm2_14'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (14, 'OUTER DIAMETER LOW', findBool(dic['ExtAlarm2_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_15 != findBool(dic['ExtAlarm2_15'])):
                tempExt2_15 = findBool(dic['ExtAlarm2_15'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (15, 'INNER DIAMETER HIGH', findBool(dic['ExtAlarm2_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_16 != findBool(dic['ExtAlarm2_16'])):
                tempExt2_16 = findBool(dic['ExtAlarm2_16'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (16, 'INNER DIAMETER LOW', findBool(dic['ExtAlarm2_16']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_17 != findBool(dic['ExtAlarm2_17'])):
                tempExt2_17 = findBool(dic['ExtAlarm2_17'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (17, 'TAKEUP2 END LIMIT ACTIVATED', findBool(dic['ExtAlarm2_17']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_18 != findBool(dic['ExtAlarm2_18'])):
                tempExt2_18 = findBool(dic['ExtAlarm2_18'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (18, 'FEEDER EMERGENCY PRESSED', findBool(dic['ExtAlarm2_18']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_19 != findBool(dic['ExtAlarm2_19'])):
                tempExt2_19 = findBool(dic['ExtAlarm2_19'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (19, 'RED TAPE SENSOR DETECTED', findBool(dic['ExtAlarm2_19']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_20 != findBool(dic['ExtAlarm2_20'])):
                tempExt2_20 = findBool(dic['ExtAlarm2_20'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (20, 'EXTRUSION MATERIAL TEMPERATURE HIGH', findBool(dic['ExtAlarm2_20']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_21 != findBool(dic['ExtAlarm2_21'])):
                tempExt2_21 = findBool(dic['ExtAlarm2_21'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (21, 'EXTRUSION MATERIAL TEMPERATURE LOW', findBool(dic['ExtAlarm2_21']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_22 != findBool(dic['ExtAlarm2_22'])):
                tempExt2_22 = findBool(dic['ExtAlarm2_22'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (22, 'SPARE-1', findBool(dic['ExtAlarm2_22']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_23 != findBool(dic['ExtAlarm2_23'])):
                tempExt2_23 = findBool(dic['ExtAlarm2_23'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (23, 'SPARE-2', findBool(dic['ExtAlarm2_23']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_24 != findBool(dic['ExtAlarm2_24'])):
                tempExt2_24 = findBool(dic['ExtAlarm2_24'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (24, 'SPARE-3', findBool(dic['ExtAlarm2_24']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_25 != findBool(dic['ExtAlarm2_25'])):
                tempExt2_25 = findBool(dic['ExtAlarm2_25'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (25, 'SCREW TEMPERATURE HIGH', findBool(dic['ExtAlarm2_25']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_26 != findBool(dic['ExtAlarm2_26'])):
                tempExt2_26 = findBool(dic['ExtAlarm2_26'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (26, 'SCREW TEMPERATURE LOW', findBool(dic['ExtAlarm2_26']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_27 != findBool(dic['ExtAlarm2_27'])):
                tempExt2_27 = findBool(dic['ExtAlarm2_27'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (27, 'EXTRUDER EMERGENCY PRESSED', findBool(dic['ExtAlarm2_27']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_28 != findBool(dic['ExtAlarm2_28'])):
                tempExt2_28 = findBool(dic['ExtAlarm2_28'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (28, 'INPUT CATTERPULLER EMERGENCY PRESSED', findBool(dic['ExtAlarm2_28']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_29 != findBool(dic['ExtAlarm2_29'])):
                tempExt2_29 = findBool(dic['ExtAlarm2_29'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (29, 'OUTPUT CATTERPULLER EMERGENCY PRESSED', findBool(dic['ExtAlarm2_29']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_30 != findBool(dic['ExtAlarm2_30'])):
                tempExt2_30 = findBool(dic['ExtAlarm2_30'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (30, 'TAKEUP1 EMERGENCY PRESSED', findBool(dic['ExtAlarm2_30']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_31 != findBool(dic['ExtAlarm2_31'])):
                tempExt2_31 = findBool(dic['ExtAlarm2_31'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (31, 'TAKEUP2 EMERGENCY PRESSED', findBool(dic['ExtAlarm2_31']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt2_32 != findBool(dic['ExtAlarm2_32'])):
                tempExt2_32 = findBool(dic['ExtAlarm2_32'])
                sql = "INSERT INTO extalarm2 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (32, 'TAKEUP1 END LIMIT ACTIVATED', findBool(dic['ExtAlarm2_32']))
                mycursor.execute(sql, val)
                mydb.commit()
                '''
        ...
        '''
        if(tempExt4_1 != findBool(dic['ExtAlarm4_1'])):
                tempExt4_1 = findBool(dic['ExtAlarm4_1'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (1, 'THICKNESS  HIGH', findBool(dic['ExtAlarm4_1']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_2 != findBool(dic['ExtAlarm4_2'])):
                tempExt4_2 = findBool(dic['ExtAlarm4_2'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (2, 'THICKNESS LOW', findBool(dic['ExtAlarm4_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_3 != findBool(dic['ExtAlarm4_3'])):
                tempExt4_3 = findBool(dic['ExtAlarm4_3'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (3, 'HEAD TEMPERATURE HIGH', findBool(dic['ExtAlarm4_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_4 != findBool(dic['ExtAlarm4_4'])):
                tempExt4_4 = findBool(dic['ExtAlarm4_4'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (4, 'HEAD TEMPERATURE LOW', findBool(dic['ExtAlarm4_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_5 != findBool(dic['ExtAlarm4_5'])):
                tempExt4_5 = findBool(dic['ExtAlarm4_5'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (5, 'ZONE 2 TEMPERATURE HIGH', findBool(dic['ExtAlarm4_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_6 != findBool(dic['ExtAlarm4_6'])):
                tempExt4_6 = findBool(dic['ExtAlarm4_6'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (6, 'ZONE 2 TEMPERATURE LOW', findBool(dic['ExtAlarm4_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_7 != findBool(dic['ExtAlarm4_7'])):
                tempExt4_7 = findBool(dic['ExtAlarm4_7'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (7, 'ZONE 3 TEMPERATURE HIGH', findBool(dic['ExtAlarm4_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_8 != findBool(dic['ExtAlarm4_8'])):
                tempExt4_8 = findBool(dic['ExtAlarm4_8'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (8, 'ZONE 3 TEMPERATURE LOW', findBool(dic['ExtAlarm4_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_9 != findBool(dic['ExtAlarm4_9'])):
                tempExt4_9 = findBool(dic['ExtAlarm4_9'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (9, 'EXTRUDER CURRENT WARNING HIGH', findBool(dic['ExtAlarm4_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_10 != findBool(dic['ExtAlarm4_10'])):
                tempExt4_10 = findBool(dic['ExtAlarm4_10'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (10, 'EXTRUDER CURRENT ALARM HIGH', findBool(dic['ExtAlarm4_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_11 != findBool(dic['ExtAlarm4_11'])):
                tempExt4_11 = findBool(dic['ExtAlarm4_11'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (11, 'EXTRUDER PRESSURE WANING HIGH', findBool(dic['ExtAlarm4_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_12 != findBool(dic['ExtAlarm4_12'])):
                tempExt4_12 = findBool(dic['ExtAlarm4_12'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (12, 'EXTRUDER PRESSURE ALARM HIGH', findBool(dic['ExtAlarm4_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_13 != findBool(dic['ExtAlarm4_13'])):
                tempExt4_13 = findBool(dic['ExtAlarm4_13'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (13, 'OUTER DIAMETER HIGH', findBool(dic['ExtAlarm4_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_14 != findBool(dic['ExtAlarm4_14'])):
                tempExt4_14 = findBool(dic['ExtAlarm4_14'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (14, 'OUTER DIAMETER LOW', findBool(dic['ExtAlarm4_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_15 != findBool(dic['ExtAlarm4_15'])):
                tempExt4_15 = findBool(dic['ExtAlarm4_15'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (15, 'INNER DIAMETER HIGH', findBool(dic['ExtAlarm4_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_16 != findBool(dic['ExtAlarm4_16'])):
                tempExt4_16 = findBool(dic['ExtAlarm4_16'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (16, 'INNER DIAMETER LOW', findBool(dic['ExtAlarm4_16']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_17 != findBool(dic['ExtAlarm4_17'])):
                tempExt4_17 = findBool(dic['ExtAlarm4_17'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (17, 'TAKEUP2 END LIMIT ACTIVATED', findBool(dic['ExtAlarm4_17']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_18 != findBool(dic['ExtAlarm4_18'])):
                tempExt4_18 = findBool(dic['ExtAlarm4_18'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (18, 'FEEDER EMERGENCY PRESSED', findBool(dic['ExtAlarm4_18']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_19 != findBool(dic['ExtAlarm4_19'])):
                tempExt4_19 = findBool(dic['ExtAlarm4_19'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (19, 'RED TAPE SENSOR DETECTED', findBool(dic['ExtAlarm4_19']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_20 != findBool(dic['ExtAlarm4_20'])):
                tempExt4_20 = findBool(dic['ExtAlarm4_20'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (20, 'EXTRUSION MATERIAL TEMPERATURE HIGH', findBool(dic['ExtAlarm4_20']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_21 != findBool(dic['ExtAlarm4_21'])):
                tempExt4_21 = findBool(dic['ExtAlarm4_21'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (21, 'EXTRUSION MATERIAL TEMPERATURE LOW', findBool(dic['ExtAlarm4_21']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_22 != findBool(dic['ExtAlarm4_22'])):
                tempExt4_22 = findBool(dic['ExtAlarm4_22'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (22, 'SPARE-1', findBool(dic['ExtAlarm4_22']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_23 != findBool(dic['ExtAlarm4_23'])):
                tempExt4_23 = findBool(dic['ExtAlarm4_23'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (23, 'SPARE-2', findBool(dic['ExtAlarm4_23']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_24 != findBool(dic['ExtAlarm4_24'])):
                tempExt4_24 = findBool(dic['ExtAlarm4_24'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (24, 'SPARE-3', findBool(dic['ExtAlarm4_24']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_25 != findBool(dic['ExtAlarm4_25'])):
                tempExt4_25 = findBool(dic['ExtAlarm4_25'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (25, 'SCREW TEMPERATURE HIGH', findBool(dic['ExtAlarm4_25']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_26 != findBool(dic['ExtAlarm4_26'])):
                tempExt4_26 = findBool(dic['ExtAlarm4_26'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (26, 'SCREW TEMPERATURE LOW', findBool(dic['ExtAlarm4_26']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_27 != findBool(dic['ExtAlarm4_27'])):
                tempExt4_27 = findBool(dic['ExtAlarm4_27'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (27, 'EXTRUDER EMERGENCY PRESSED', findBool(dic['ExtAlarm4_27']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_28 != findBool(dic['ExtAlarm4_28'])):
                tempExt4_28 = findBool(dic['ExtAlarm4_28'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (28, 'INPUT CATTERPULLER EMERGENCY PRESSED', findBool(dic['ExtAlarm4_28']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_29 != findBool(dic['ExtAlarm4_29'])):
                tempExt4_29 = findBool(dic['ExtAlarm4_29'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (29, 'OUTPUT CATTERPULLER EMERGENCY PRESSED', findBool(dic['ExtAlarm4_29']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_30 != findBool(dic['ExtAlarm4_30'])):
                tempExt4_30 = findBool(dic['ExtAlarm4_30'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (30, 'TAKEUP1 EMERGENCY PRESSED', findBool(dic['ExtAlarm4_30']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_31 != findBool(dic['ExtAlarm4_31'])):
                tempExt4_31 = findBool(dic['ExtAlarm4_31'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (31, 'TAKEUP2 EMERGENCY PRESSED', findBool(dic['ExtAlarm4_31']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(tempExt4_32 != findBool(dic['ExtAlarm4_32'])):
                tempExt4_32 = findBool(dic['ExtAlarm4_32'])
                sql = "INSERT INTO extalarm4 ( alarm_id, alarm_name , status ) VALUES (%s,%s,%s)"
                val = (32, 'TAKEUP1 END LIMIT ACTIVATED', findBool(dic['ExtAlarm4_32']))
                mycursor.execute(sql, val)
                mydb.commit()
                '''
        ...
        if(globalBS.tempTest1_1 != findBool(dic['TestAlarm1_1'])):
                ...
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_2 != findBool(dic['TestAlarm1_2'])):
                globalBS.tempMan1_2 = findBool(dic['TestAlarm1_2'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 2, 'WATER PUMP TRIPPED', findBool(dic['TestAlarm1_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_3 != findBool(dic['TestAlarm1_3'])):
                globalBS.tempMan1_3 = findBool(dic['TestAlarm1_3'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 3, 'HMI PANEL EMERGENCY PRESSED', findBool(dic['TestAlarm1_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_4 != findBool(dic['TestAlarm1_4'])):
                globalBS.tempMan1_4 = findBool(dic['TestAlarm1_4'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 4, 'MAIN DRIVE FAULT DETECTED', findBool(dic['TestAlarm1_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_5 != findBool(dic['TestAlarm1_5'])):
                globalBS.tempMan1_5 = findBool(dic['TestAlarm1_5'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 5, 'WATER FILTER CHOKED', findBool(dic['TestAlarm1_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_6 != findBool(dic['TestAlarm1_6'])):
                globalBS.tempMan1_6 = findBool(dic['TestAlarm1_6'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 6, 'WATER LEVEL LOW', findBool(dic['TestAlarm1_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_7 != findBool(dic['TestAlarm1_7'])):
                globalBS.tempMan1_7 = findBool(dic['TestAlarm1_7'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 7, 'AIR PRESSURE LOW', findBool(dic['TestAlarm1_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_8 != findBool(dic['TestAlarm1_8'])):
                globalBS.tempMan1_8 = findBool(dic['TestAlarm1_8'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 8, 'WATER MINIMUM PRESSURE NOT REACHED', findBool(dic['TestAlarm1_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_9 != findBool(dic['TestAlarm1_9'])):
                globalBS.tempMan1_9 = findBool(dic['TestAlarm1_9'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 9, 'PIR NUMBER NOT ENTERED', findBool(dic['TestAlarm1_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_10 != findBool(dic['TestAlarm1_10'])):
                globalBS.tempMan1_10 = findBool(dic['TestAlarm1_10'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 10, 'SET EXRACTION PRESSURE NOT ENTERED', findBool(dic['TestAlarm1_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_11 != findBool(dic['TestAlarm1_11'])):
                globalBS.tempMan1_11 = findBool(dic['TestAlarm1_11'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 11, 'SET TEST PRESSURE NOT ENTERED', findBool(dic['TestAlarm1_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_12 != findBool(dic['TestAlarm1_12'])):
                globalBS.tempMan1_12 = findBool(dic['TestAlarm1_12'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 12, 'RIGHT CLAMP EMERGENCY PRESSED', findBool(dic['TestAlarm1_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_13 != findBool(dic['TestAlarm1_13'])):
                globalBS.tempMan1_13 = findBool(dic['TestAlarm1_13'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 13, 'LEFT CLAMP EMERGENCY PRESSED', findBool(dic['TestAlarm1_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_14 != findBool(dic['TestAlarm1_14'])):
                globalBS.tempMan1_14 = findBool(dic['TestAlarm1_14'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 14, 'CHECK CLAMPING LIMIT PRESSURE', findBool(dic['TestAlarm1_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_15 != findBool(dic['TestAlarm1_15'])):
                globalBS.tempMan1_15 = findBool(dic['TestAlarm1_15'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing1_1'], dic['Testing1_2'], 15, 'MAIN DRIVE NOT READY', findBool(dic['TestAlarm1_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan1_16 != findBool(dic['TestAlarm1_16'])):
                globalBS.tempMan1_16 = findBool(dic['TestAlarm1_16'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
        ...
        if(globalBS.tempTest2_2 != findBool(dic['TestAlarm2_2'])):
                globalBS.tempMan2_2 = findBool(dic['TestAlarm2_2'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 2, 'WATER PUMP TRIPPED', findBool(dic['TestAlarm2_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_3 != findBool(dic['TestAlarm2_3'])):
                globalBS.tempMan2_3 = findBool(dic['TestAlarm2_3'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 3, 'HMI PANEL EMERGENCY PRESSED', findBool(dic['TestAlarm2_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_4 != findBool(dic['TestAlarm2_4'])):
                globalBS.tempMan2_4 = findBool(dic['TestAlarm2_4'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 4, 'MAIN DRIVE FAULT DETECTED', findBool(dic['TestAlarm2_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_5 != findBool(dic['TestAlarm2_5'])):
                globalBS.tempMan2_5 = findBool(dic['TestAlarm2_5'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 5, 'WATER FILTER CHOKED', findBool(dic['TestAlarm2_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_6 != findBool(dic['TestAlarm2_6'])):
                globalBS.tempMan2_6 = findBool(dic['TestAlarm2_6'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 6, 'WATER LEVEL LOW', findBool(dic['TestAlarm2_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_7 != findBool(dic['TestAlarm2_7'])):
                globalBS.tempMan2_7 = findBool(dic['TestAlarm2_7'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 7, 'AIR PRESSURE LOW', findBool(dic['TestAlarm2_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_8 != findBool(dic['TestAlarm2_8'])):
                globalBS.tempMan2_8 = findBool(dic['TestAlarm2_8'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 8, 'WATER MINIMUM PRESSURE NOT REACHED', findBool(dic['TestAlarm2_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_9 != findBool(dic['TestAlarm2_9'])):
                globalBS.tempMan2_9 = findBool(dic['TestAlarm2_9'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 9, 'PIR NUMBER NOT ENTERED', findBool(dic['TestAlarm2_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_10 != findBool(dic['TestAlarm2_10'])):
                globalBS.tempMan2_10 = findBool(dic['TestAlarm2_10'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 10, 'SET EXRACTION PRESSURE NOT ENTERED', findBool(dic['TestAlarm2_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_11 != findBool(dic['TestAlarm2_11'])):
                globalBS.tempMan2_11 = findBool(dic['TestAlarm2_11'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 11, 'SET TEST PRESSURE NOT ENTERED', findBool(dic['TestAlarm2_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_12 != findBool(dic['TestAlarm2_12'])):
                globalBS.tempMan2_12 = findBool(dic['TestAlarm2_12'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 12, 'RIGHT CLAMP EMERGENCY PRESSED', findBool(dic['TestAlarm2_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_13 != findBool(dic['TestAlarm2_13'])):
                globalBS.tempMan2_13 = findBool(dic['TestAlarm2_13'])
                sql = "INSERT INTO testalarm1 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 13, 'LEFT CLAMP EMERGENCY PRESSED', findBool(dic['TestAlarm2_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_14 != findBool(dic['TestAlarm2_14'])):
                globalBS.tempMan2_14 = findBool(dic['TestAlarm2_14'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 14, 'CHECK CLAMPING LIMIT PRESSURE', findBool(dic['TestAlarm2_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_15 != findBool(dic['TestAlarm2_15'])):
                globalBS.tempMan2_15 = findBool(dic['TestAlarm2_15'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing2_1'], dic['Testing2_2'], 15, 'MAIN DRIVE NOT READY', findBool(dic['TestAlarm2_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan2_16 != findBool(dic['TestAlarm2_16'])):
                globalBS.tempMan2_16 = findBool(dic['TestAlarm2_16'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
        ...
        if(globalBS.tempTest3_2 != findBool(dic['TestAlarm3_2'])):
                globalBS.tempMan3_2 = findBool(dic['TestAlarm3_2'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 2, 'WATER PUMP TRIPPED', findBool(dic['TestAlarm3_2']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_3 != findBool(dic['TestAlarm3_3'])):
                globalBS.tempMan3_3 = findBool(dic['TestAlarm3_3'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 3, 'HMI PANEL EMERGENCY PRESSED', findBool(dic['TestAlarm3_3']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_4 != findBool(dic['TestAlarm3_4'])):
                globalBS.tempMan3_4 = findBool(dic['TestAlarm3_4'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 4, 'MAIN DRIVE FAULT DETECTED', findBool(dic['TestAlarm3_4']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_5 != findBool(dic['TestAlarm3_5'])):
                globalBS.tempMan3_5 = findBool(dic['TestAlarm3_5'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 5, 'WATER FILTER CHOKED', findBool(dic['TestAlarm3_5']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_6 != findBool(dic['TestAlarm3_6'])):
                globalBS.tempMan3_6 = findBool(dic['TestAlarm3_6'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 6, 'WATER LEVEL LOW', findBool(dic['TestAlarm3_6']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_7 != findBool(dic['TestAlarm3_7'])):
                globalBS.tempMan3_7 = findBool(dic['TestAlarm3_7'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 7, 'AIR PRESSURE LOW', findBool(dic['TestAlarm3_7']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_8 != findBool(dic['TestAlarm3_8'])):
                globalBS.tempMan3_8 = findBool(dic['TestAlarm3_8'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 8, 'WATER MINIMUM PRESSURE NOT REACHED', findBool(dic['TestAlarm3_8']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_9 != findBool(dic['TestAlarm3_9'])):
                globalBS.tempMan3_9 = findBool(dic['TestAlarm3_9'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 9, 'PIR NUMBER NOT ENTERED', findBool(dic['TestAlarm3_9']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_10 != findBool(dic['TestAlarm3_10'])):
                globalBS.tempMan3_10 = findBool(dic['TestAlarm3_10'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 10, 'SET EXRACTION PRESSURE NOT ENTERED', findBool(dic['TestAlarm3_10']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_11 != findBool(dic['TestAlarm3_11'])):
                globalBS.tempMan3_11 = findBool(dic['TestAlarm3_11'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 11, 'SET TEST PRESSURE NOT ENTERED', findBool(dic['TestAlarm3_11']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_12 != findBool(dic['TestAlarm3_12'])):
                globalBS.tempMan3_12 = findBool(dic['TestAlarm3_12'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 12, 'RIGHT CLAMP EMERGENCY PRESSED', findBool(dic['TestAlarm3_12']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_13 != findBool(dic['TestAlarm3_13'])):
                globalBS.tempMan3_13 = findBool(dic['TestAlarm3_13'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 13, 'LEFT CLAMP EMERGENCY PRESSED', findBool(dic['TestAlarm3_13']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_14 != findBool(dic['TestAlarm3_14'])):
                globalBS.tempMan3_14 = findBool(dic['TestAlarm3_14'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 14, 'CHECK CLAMPING LIMIT PRESSURE', findBool(dic['TestAlarm3_14']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_15 != findBool(dic['TestAlarm3_15'])):
                globalBS.tempMan3_15 = findBool(dic['TestAlarm3_15'])
                sql = "INSERT INTO testalarm2 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
                val = (dic['Testing3_1'], dic['Testing3_2'], 15, 'MAIN DRIVE NOT READY', findBool(dic['TestAlarm3_15']))
                mycursor.execute(sql, val)
                mydb.commit()
        if(globalBS.tempMan3_16 != findBool(dic['TestAlarm3_16'])):
                globalBS.tempMan3_16 = findBool(dic['TestAlarm3_16'])
                sql = "INSERT INTO testalarm3 ( pir, operator_name, alarm_id, alarm_name , status ) VALUES (%s,%s,%s,%s,%s)"
        ...
        val = (int(dic['ManPims1_1']),int(dic['ManPims1_2']))
        mycursor.execute(sql, val)
        mydb.commit()

        sql = "INSERT INTO manpims2 ( drum_in, drum_out ) VALUES (%s,%s)"
        val = (int(dic['ManPims2_1']),int(dic['ManPims2_2']))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        sql = "INSERT INTO manpims3 ( drum_in, drum_out ) VALUES (%s,%s)"
        val = (int(dic['ManPims3_1']),int(dic['ManPims3_2']))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        
        sql = "INSERT INTO vulpims1 ( drum_in, drum_out ) VALUES (%s,%s)"
        val = (int(dic['VulPims1_1']),int(dic['VulPims1_2']))
        mycursor.execute(sql, val)
        mydb.commit()
        ...
        val = ( findFloat(float(dic['ExtPims1_3'])), findFloat(float(dic['ExtPims1_4'])), 
                ...
                int(dic['ExtPims1_1']), int(dic['ExtPims1_2']))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        sql = "INSERT INTO extpims2 ( rtm_1 , rtm_2 , rtm_3 , rtm_4 , rtm_5, rtm_6, rtm_7, rtm_8, rtm_9, rtm_10, rtm_11 , rtm_12 , rtm_13 , rtm_14 , rtm_15, rtm_16, rtm_17, rtm_18, rtm_19, rtm_20, rtm_21 , rtm_22 , rtm_23 , rtm_24 , rtm_25, rtm_26, rtm_27, rtm_28, rtm_29, rtm_30, rtm_31 , rtm_32 , rtm_33 , rtm_34 , rtm_35, rtm_36, rtm_37, rtm_38, rtm_39, rtm_40, rtm_41 , rtm_42 , rtm_43 , rtm_44 , rtm_45, rtm_46, rtm_47, rtm_48, rtm_49, rtm_50, rtm_51 , rtm_52 , rtm_53 , rtm_54 , rtm_55, rtm_56, rtm_57, rtm_58, rtm_59, rtm_60, rtm_61 , rtm_62 , rtm_63 , rtm_64 , rtm_65, rtm_66, rtm_67, rtm_68, rtm_69, rtm_70, rtm_71 , rtm_72 , rtm_73 , rtm_74 , rtm_75, rtm_76, rtm_77, rtm_78, rtm_79, rtm_80, drum_in, drum_out) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = ( findFloat(float(dic['ExtPims2_1'])), findFloat(float(dic['ExtPims2_2'])),
                findFloat(float(dic['ExtPims2_3'])), findFloat(float(dic['ExtPims2_4'])), 
                findFloat(float(dic['ExtPims2_5'])), findFloat(float(dic['ExtPims2_6'])), 
                findFloat(float(dic['ExtPims2_7'])), findFloat(float(dic['ExtPims2_8'])), 
                findFloat(float(dic['ExtPims2_9'])), findFloat(float(dic['ExtPims2_10'])),  
                findFloat(float(dic['ExtPims2_11'])), findFloat(float(dic['ExtPims2_12'])), 
                findFloat(float(dic['ExtPims2_13'])), findFloat(float(dic['ExtPims2_14'])), 
                findFloat(float(dic['ExtPims2_15'])), findFloat(float(dic['ExtPims2_16'])), 
                findFloat(float(dic['ExtPims2_17'])), findFloat(float(dic['ExtPims2_18'])), 
                findFloat(float(dic['ExtPims2_19'])), findFloat(float(dic['ExtPims2_20'])), 
                findFloat(float(dic['ExtPims2_21'])), findFloat(float(dic['ExtPims2_22'])), 
                findFloat(float(dic['ExtPims2_23'])), findFloat(float(dic['ExtPims2_24'])), 
                findFloat(float(dic['ExtPims2_25'])), findFloat(float(dic['ExtPims2_26'])), 
                findFloat(float(dic['ExtPims2_27'])), findFloat(float(dic['ExtPims2_28'])), 
                findFloat(float(dic['ExtPims2_29'])), findFloat(float(dic['ExtPims2_30'])),
                findFloat(float(dic['ExtPims2_31'])), findFloat(float(dic['ExtPims2_32'])), 
                findFloat(float(dic['ExtPims2_33'])), findFloat(float(dic['ExtPims2_34'])), 
                findFloat(float(dic['ExtPims2_35'])), findFloat(float(dic['ExtPims2_36'])), 
                findFloat(float(dic['ExtPims2_37'])), findFloat(float(dic['ExtPims2_38'])), 
                findFloat(float(dic['ExtPims2_39'])), findFloat(float(dic['ExtPims2_40'])), 
                findFloat(float(dic['ExtPims2_41'])), findFloat(float(dic['ExtPims2_42'])), 
                findFloat(float(dic['ExtPims2_43'])), findFloat(float(dic['ExtPims2_44'])), 
                findFloat(float(dic['ExtPims2_45'])), findFloat(float(dic['ExtPims2_46'])), 
                findFloat(float(dic['ExtPims2_47'])), findFloat(float(dic['ExtPims2_48'])), 
                findFloat(float(dic['ExtPims2_49'])), findFloat(float(dic['ExtPims2_50'])), 
                findFloat(float(dic['ExtPims2_51'])), findFloat(float(dic['ExtPims2_52'])), 
                findFloat(float(dic['ExtPims2_53'])), findFloat(float(dic['ExtPims2_54'])), 
                findFloat(float(dic['ExtPims2_55'])), findFloat(float(dic['ExtPims2_56'])), 
                findFloat(float(dic['ExtPims2_57'])), findFloat(float(dic['ExtPims2_58'])), 
                findFloat(float(dic['ExtPims2_59'])), findFloat(float(dic['ExtPims2_60'])), 
                findFloat(float(dic['ExtPims2_61'])), findFloat(float(dic['ExtPims2_62'])), 
                findFloat(float(dic['ExtPims2_63'])), findFloat(float(dic['ExtPims2_64'])), 
                findFloat(float(dic['ExtPims2_65'])), findFloat(float(dic['ExtPims2_66'])), 
                findFloat(float(dic['ExtPims2_67'])), findFloat(float(dic['ExtPims2_68'])), 
                findFloat(float(dic['ExtPims2_69'])), findFloat(float(dic['ExtPims2_70'])), 
                findFloat(float(dic['ExtPims2_71'])), findFloat(float(dic['ExtPims2_72'])), 
                findFloat(float(dic['ExtPims2_73'])), findFloat(float(dic['ExtPims2_74'])), 
                findFloat(float(dic['ExtPims2_75'])), findFloat(float(dic['ExtPims2_76'])), 
                findFloat(float(dic['ExtPims2_77'])), findFloat(float(dic['ExtPims2_78'])),
                findFloat(float(dic['ExtPims2_79'])), findFloat(float(dic['ExtPims2_80'])),
                int(dic['ExtPims2_81']), int(dic['ExtPims2_82']))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        ...
        val = ( findFloat(float(dic['ExtPims3_3'])), findFloat(float(dic['ExtPims3_4'])), 
                ...
                int(dic['ExtPims3_1']), int(dic['ExtPims3_2']))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        sql = "INSERT INTO extpims4 ( rtm_1 , rtm_2 , rtm_3 , rtm_4 , rtm_5, rtm_6, rtm_7, rtm_8, rtm_9, rtm_10, rtm_11 , rtm_12 , rtm_13 , rtm_14 , rtm_15, rtm_16, rtm_17, rtm_18, rtm_19, rtm_20, rtm_21 , rtm_22 , rtm_23 , rtm_24 , rtm_25, rtm_26, rtm_27, rtm_28, rtm_29, rtm_30, rtm_31 , rtm_32 , rtm_33 , rtm_34 , rtm_35, rtm_36, rtm_37, rtm_38, rtm_39, rtm_40, rtm_41 , rtm_42 , rtm_43 , rtm_44 , rtm_45, rtm_46, rtm_47, rtm_48, rtm_49, rtm_50, rtm_51 , rtm_52 , rtm_53 , rtm_54 , rtm_55, rtm_56, rtm_57, rtm_58, rtm_59, rtm_60, rtm_61 , rtm_62 , rtm_63 , rtm_64 , rtm_65, rtm_66, rtm_67, rtm_68, rtm_69, rtm_70, rtm_71 , rtm_72 , rtm_73 , rtm_74 , rtm_75, rtm_76, rtm_77, rtm_78, rtm_79, rtm_80, drum_in, drum_out) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        val = ( findFloat(float(dic['ExtPims4_1'])), findFloat(float(dic['ExtPims4_2'])),
                findFloat(float(dic['ExtPims4_3'])), findFloat(float(dic['ExtPims4_4'])), 
                findFloat(float(dic['ExtPims4_5'])), findFloat(float(dic['ExtPims4_6'])), 
                findFloat(float(dic['ExtPims4_7'])), findFloat(float(dic['ExtPims4_8'])), 
                findFloat(float(dic['ExtPims4_9'])), findFloat(float(dic['ExtPims4_10'])),  
                findFloat(float(dic['ExtPims4_11'])), findFloat(float(dic['ExtPims4_12'])), 
                findFloat(float(dic['ExtPims4_13'])), findFloat(float(dic['ExtPims4_14'])), 
                findFloat(float(dic['ExtPims4_15'])), findFloat(float(dic['ExtPims4_16'])), 
                findFloat(float(dic['ExtPims4_17'])), findFloat(float(dic['ExtPims4_18'])), 
                findFloat(float(dic['ExtPims4_19'])), findFloat(float(dic['ExtPims4_20'])), 
                findFloat(float(dic['ExtPims4_21'])), findFloat(float(dic['ExtPims4_22'])), 
                findFloat(float(dic['ExtPims4_23'])), findFloat(float(dic['ExtPims4_24'])), 
                findFloat(float(dic['ExtPims4_25'])), findFloat(float(dic['ExtPims4_26'])), 
                findFloat(float(dic['ExtPims4_27'])), findFloat(float(dic['ExtPims4_28'])), 
                findFloat(float(dic['ExtPims4_29'])), findFloat(float(dic['ExtPims4_30'])),
                findFloat(float(dic['ExtPims4_31'])), findFloat(float(dic['ExtPims4_32'])), 
                findFloat(float(dic['ExtPims4_33'])), findFloat(float(dic['ExtPims4_34'])), 
                findFloat(float(dic['ExtPims4_35'])), findFloat(float(dic['ExtPims4_36'])), 
                findFloat(float(dic['ExtPims4_37'])), findFloat(float(dic['ExtPims4_38'])), 
                findFloat(float(dic['ExtPims4_39'])), findFloat(float(dic['ExtPims4_40'])), 
                findFloat(float(dic['ExtPims4_41'])), findFloat(float(dic['ExtPims4_42'])), 
                findFloat(float(dic['ExtPims4_43'])), findFloat(float(dic['ExtPims4_44'])), 
                findFloat(float(dic['ExtPims4_45'])), findFloat(float(dic['ExtPims4_46'])), 
                findFloat(float(dic['ExtPims4_47'])), findFloat(float(dic['ExtPims4_48'])), 
                findFloat(float(dic['ExtPims4_49'])), findFloat(float(dic['ExtPims4_50'])), 
                findFloat(float(dic['ExtPims4_51'])), findFloat(float(dic['ExtPims4_52'])), 
                findFloat(float(dic['ExtPims4_53'])), findFloat(float(dic['ExtPims4_54'])), 
                findFloat(float(dic['ExtPims4_55'])), findFloat(float(dic['ExtPims4_56'])), 
                findFloat(float(dic['ExtPims4_57'])), findFloat(float(dic['ExtPims4_58'])), 
                findFloat(float(dic['ExtPims4_59'])), findFloat(float(dic['ExtPims4_60'])), 
                findFloat(float(dic['ExtPims4_61'])), findFloat(float(dic['ExtPims4_62'])), 
                findFloat(float(dic['ExtPims4_63'])), findFloat(float(dic['ExtPims4_64'])), 
                findFloat(float(dic['ExtPims4_65'])), findFloat(float(dic['ExtPims4_66'])), 
                findFloat(float(dic['ExtPims4_67'])), findFloat(float(dic['ExtPims4_68'])), 
                findFloat(float(dic['ExtPims4_69'])), findFloat(float(dic['ExtPims4_70'])), 
                findFloat(float(dic['ExtPims4_71'])), findFloat(float(dic['ExtPims4_72'])), 
                findFloat(float(dic['ExtPims4_73'])), findFloat(float(dic['ExtPims4_74'])), 
                findFloat(float(dic['ExtPims4_75'])), findFloat(float(dic['ExtPims4_76'])), 
                findFloat(float(dic['ExtPims4_77'])), findFloat(float(dic['ExtPims4_78'])),
                findFloat(float(dic['ExtPims4_79'])), findFloat(float(dic['ExtPims4_80'])),
                int(dic['ExtPims4_81']), int(dic['ExtPims4_82']))
        mycursor.execute(sql, val)
        mydb.commit()
        '''
        ...
        val = ( int(dic['TestPims1_1']), int(dic['TestPims1_2']),
        ...
        val = ( int(dic['TestPims2_1']), int(dic['TestPims2_2']),
        ...
        val = ( int(dic['TestPims3_1']), int(dic['TestPims3_2']),
